...
class CreateDefaultContentForSellerListener
{
    /**
    ...
    public function handle(object $event): void
    {
        ...
        $defaultCategories = [
            ['name' => 'بدون تصنيف', 'description' => 'صنف عام لكل المنتجات', 'slug' => tenant_to_slug($seller->tenant_id).'-cat0'],
            ['name' => 'الصنف-1', 'description' => 'وصف الصنف الأول', 'slug' => tenant_to_slug($seller->tenant_id).'-cat1'],
            ['name' => 'الصنف-2', 'description' => 'وصف الصنف الثاني', 'slug' => tenant_to_slug($seller->tenant_id).'-cat2'],
            ['name' => 'الصنف-3', 'description' => 'وصف الصنف الثالث', 'slug' => tenant_to_slug($seller->tenant_id).'-cat3'],
        ];
        $image_index = 0;
        ...
        // get seller default category
        $default_category = Category::where('slug', tenant_to_slug($seller->tenant_id).'-cat0')->first();
        // ctreate default products
        $defaultProducts = [
            [
                'name' => 'منتج 1',
                'slug' => tenant_to_slug($seller->tenant_id).'-product-1',
            ...
            [
                'name' => 'منتج 2',
                'slug' => tenant_to_slug($seller->tenant_id).'-product-2',
            ...
            [
                'name' => 'منتج 3',
                'slug' => tenant_to_slug($seller->tenant_id).'-product-3',
            ...
            [
                'name' => 'منتج 4',
                'slug' => tenant_to_slug($seller->tenant_id).'-product-4',
        ...
        foreach ($defaultProducts as $productData) {
            SellerProducts::create(array_merge($productData, [
                'seller_id' => $seller->id, // ربط المنتج بالمورد
        ...
        foreach ($defaultFqa as $fqaData) {
            SellerFqa::create($fqaData);
        }
        // create default pages
        // صفحة عن المتجر
        SellerPage::create([
            'title' => 'عن المتجر',
            'slug' => tenant_to_slug($seller->tenant_id).'-about',
        ...
        SellerPage::create([
            'title' => 'شحن و التسليم',
            'slug' => tenant_to_slug($seller->tenant_id).'-shipping-policy',
...
',
        ...
        SellerPage::create([
            'title' => 'طرق الدفع',
            'slug' => tenant_to_slug($seller->tenant_id).'-payment-policy',
...
',
        ...
        SellerPage::create([
            ...
            'slug' => tenant_to_slug($seller->tenant_id).'-terms-of-use',
...
',
        ...
        SellerPage::create([
            ...
            'slug' => tenant_to_slug($seller->tenant_id).'-exchange-policy',
...
',
        ...
        SellerPage::create([
            ...
            'slug' => tenant_to_slug($seller->tenant_id).'-privacy-policy',
...
',
        ...
        SellerPage::create([
            'title' => 'اتصل بنا',
            'slug' => tenant_to_slug($seller->tenant_id).'-contact-us',
...
',
        ...
        SellerPage::create([
            ...
            'slug' => tenant_to_slug($seller->tenant_id).'-faq',
