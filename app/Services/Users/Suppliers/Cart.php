...
class Cart
{
    ...
    {
        $price = get_supplier_product_price($product->id);
        ...
        $aditional_price = 0;
        if ($attribute_id != 0) {
            $attribute = SupplierProductAttributes::find($attribute_id);
            if ($attribute) {
        ...
        if (!array_key_exists($product->id, $this->items)) {
            ...
            if (($variation_id != 0 && $attribute_id ==0) || ($variation_id != 0 && $attribute_id !=0)) {
                // get variation data
                $variations = SupplierProductVariations::find($variation_id);
            ...
            if (($attribute_id != 0 && $variation_id==0) || ($variation_id != 0 && $attribute_id !=0)) {
                // get attribute data
                $attributes = SupplierProductAttributes::find($attribute_id);
        ...
        //   $variation=SupplierProductVariations::find(request()->variation_id);
        //   if($variation)
        //   {
