...
class SupplierCategoriesCouponsController extends Controller
{
/**
    ...
    public function index()
    {
        ...
        return view('users.suppliers.coupons.categories-coupons.index', compact('coupons', 'categories', 'linkedCategories'));
    }
