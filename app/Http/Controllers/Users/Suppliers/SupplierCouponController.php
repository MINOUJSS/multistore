...
class SupplierCouponController extends Controller
{

    public function index()
    {
    //   $coupons = userCoupons::with(['users', 'categories', 'Supplier_products'])->latest()->paginate(10);
        $coupons = userCoupons::where('user_id', auth()->user()->id)->latest()->paginate(10);
        $users = User::all();
        $categories = Category::all();
        $products = SupplierProducts::all();
        return view('users.suppliers.coupons.index', compact('coupons', 'users', 'categories', 'products'));
    }
    ...
    public function edit($id)
    {
        ...
        // $coupon->load(['users', 'categories', 'Supplier_products']);
        $coupon->with('users', 'categories', 'Supplier_products');
    ...
    public function update(Request $request, $id)
    {
        ...
        //     $coupon->Supplier_products()->detach();
    ...
    public function filter(Request $request)
    {
        ...
        return response()->json([
            'html' => view('users.suppliers.components.content.coupons.partials.coupon_table', compact('coupons', 'users', 'categories', 'products'))->render(),
        ]);
    }
}
