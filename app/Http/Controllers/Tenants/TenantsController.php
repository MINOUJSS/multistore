...
class TenantsController extends Controller
{
    ...
    public function index()
    {
        ...
        if (get_user_data(tenant('id')) != null && get_user_data(tenant('id'))->type == 'supplier') {
            ...
            return view('stores.sellers.index', compact('sliders', 'slider_status', 'categories', 'categories_status', 'products', 'faqs', 'faqs_status', 'store_settings', 'benefit_section', 'benefit_elements'));
        }
    ...
    public function about()
    {
        ...
        if (get_user_data(tenant('id')) != null && get_user_data(tenant('id'))->type == 'supplier') {
            ...
            // get user data
            $page = SellerPage::where('slug', tenant_to_slug(tenant('id')).'-about')->first();

            // return idex view with user data
            return view('stores.sellers.pages.about', compact('page'));
        }
    ...
    public function privacy_policy()
    {
        ...
        if (get_user_data(tenant('id')) != null && get_user_data(tenant('id'))->type == 'supplier') {
            ...
            // return idex view with user data
            return view('stores.sellers.pages.privacy_policy', compact('page'));
        }
    ...
    public function contact_us()
    {
        ...
        if (get_user_data(tenant('id')) != null && get_user_data(tenant('id'))->type == 'supplier') {
            ...
            // return idex view with user data
            return view('stores.sellers.pages.contact_us', compact('page'));
        }
    ...
    public function exchange_policy()
    {
        ...
        if (get_user_data(tenant('id')) != null && get_user_data(tenant('id'))->type == 'supplier') {
            ...
            // return idex view with user data
            return view('stores.sellers.pages.exchange_and_return_policy', compact('page'));
        }
    ...
    public function payment_policy()
    {
        ...
        if (get_user_data(tenant('id')) != null && get_user_data(tenant('id'))->type == 'supplier') {
            ...
            // return idex view with user data
            return view('stores.sellers.pages.payment_methods', compact('page'));
        }
    ...
    public function shipping_policy()
    {
        ...
        if (get_user_data(tenant('id')) != null && get_user_data(tenant('id'))->type == 'supplier') {
            ...
            // return idex view with user data
            return view('stores.sellers.pages.shipping_and_handling', compact('page'));
        }
    ...
    public function terms_of_use()
    {
        ...
        if (get_user_data(tenant('id')) != null && get_user_data(tenant('id'))->type == 'supplier') {
            ...
            // return idex view with user data
            return view('stores.sellers.pages.terms_of_use', compact('page'));
        }
    ...
    public function faq()
    {
        ...
        if (get_user_data(tenant('id')) != null && get_user_data(tenant('id'))->type == 'supplier') {
            ...
            // return idex view with user data
            return view('stores.sellers.pages.faq', compact('page'));
        }
    ...
    public function categories()
    {
        ...
        if (get_user_data(tenant('id')) != null && get_user_data(tenant('id'))->type == 'supplier') {
            ...
            // return idex view with user data
            return view('stores.sellers.categories', compact('categories'));
        }
    ...
    public function products()
    {
        ...
        if (get_user_data(tenant('id')) != null && get_user_data(tenant('id'))->type == 'supplier') {
            ...
            // return idex view with user data
            return view('stores.sellers.products', compact('products'));
        }
    ...
    public function product($id, Request $request)
    {
        ...
        if (get_user_data(tenant('id')) != null && get_user_data(tenant('id'))->type == 'supplier') {
            ...
            $wilayas = ShippingPrice::where('user_id', get_user_data(tenant('id'))->id)->where('shipping_available_to_wilaya', 1)->get();
            $product = SellerProducts::where('seller_id', get_seller_data(tenant('id'))->id)->where('id', $id)->first();
            if (!$product) {
                return abort(404);
            }
            ...
            // التحقق من عدم تسجيل الزيارة سابقًا لتجنب التكرار غير الضروري
            $existingVisit = SellerProductsVisits::where('product_id', $id)
                ->where('ip_address', $ipAddress)
                ->whereDate('visited_at', now()->toDateString()) // نفس اليوم
                ->first();
            if (!$existingVisit) {
                // إنشاء سجل جديد
                SellerProductsVisits::create([
                    'product_id' => $id,
                    'ip_address' => $ipAddress,
                    'user_agent' => $userAgent,
                    'user_id' => $userId,
    ...
    public function products_by_category($category_id)
    {
        ...
        if (get_user_data(tenant('id')) != null && get_user_data(tenant('id'))->type == 'supplier') {
            ...
            // return idex view with user data
            return view('stores.sellers.products-by-category', compact('products'));
        }
    ...
    public function order(Request $request)
    {
        ...
        if (get_user_data(tenant('id')) && get_user_data(tenant('id'))->type == 'supplier') {
            ...
            try {
                DB::beginTransaction(); // بدء المعاملة
                // delete order abandoned from data base
                $order_abandoned = SellerOrderAbandoned::where('phone', $request->phone)->first();
                if ($order_abandoned) {
                    $order_abandoned->delete();
                }
                // -----------لمنع الطلبات الوهمية----------------
                ...
                // 1. تحقق من عدد الطلبات السابقة بنفس IP خلال آخر 24 ساعة
                $ordersFromSameIP = SellerOrders::where('ip_address', $ip)
                    ->where('created_at', '>=', now()->subDay())
                    ->count();
                if ($ordersFromSameIP > 3) {
                    $riskScore += 40;
                ...
                // 3. تحقق من عدد الطلبات من نفس البصمة
                $ordersFromSameDevice = SellerOrders::where('device_fingerprint', $deviceFingerprint)
                    ->where('created_at', '>=', now()->subDay())
                    ->count();
                if ($ordersFromSameDevice > 2) {
                    $riskScore += 30;
                ...
                $planId = get_seller_subscription_data($sellerId)->plan_id;
    ...
    public function order_abandoned(Request $request)
    {
        ...
        if (get_user_data(tenant('id')) && get_user_data(tenant('id'))->type == 'supplier') {
            ...
            try {
                ...
                // get shipping cost
                // $shipping_cost=get_shipping_cost($request->shipping_and_point,$request->wilaya,$request->dayra,$request->baladia);
                $sellerOrder = SellerOrderAbandoned::create([
                    'seller_id' => $product->seller_id,
                    'order_number' => $orderNumber,
                    'customer_name' => $request->name,
                    'phone' => $request->phone,
    ...
    public function order_with_items(Request $request)
    {
        ...
        if (get_user_data(tenant('id')) && get_user_data(tenant('id'))->type == 'supplier') {
            ...
            try {
                ...
                $s_product = SellerProducts::findOrfail($product_id);
                // -----------لمنع الطلبات الوهمية----------------
                // الحصول على بيانات العميل
                $ip = $request->ip();
                $userAgent = $request->header('User-Agent');
    ...
    public function checkout()
    {
        ...
        if (get_user_data(tenant('id')) != null && get_user_data(tenant('id'))->type == 'supplier') {
            ...
            // return idex view with user data
            return view('stores.sellers.checkout', compact('wilayas', 'order_form'));
        }
    ...
    public function show_chargily_pay($order_id)
    {
        ...
        if (get_user_data(tenant('id')) != null && get_user_data(tenant('id'))->type == 'supplier') {
            ...
            $wilayas = Wilaya::get();
            // $items=SellerOrderItems::where('order_id',$order->id)->get();

            // dd('order: '.$order->items.'items: '.$items);
            // return idex view with user data
            return view('stores.sellers.payments.chargily.index', compact('order', 'wilayas'));
        }
    ...
    public function show_verments_pay($order_id)
    {
        ...
        if (get_user_data(tenant('id')) != null && get_user_data(tenant('id'))->type == 'supplier') {
            ...
            // return idex view with user data
            return view('stores.sellers.payments.verments.index', compact('order', 'wilayas'));
        }
