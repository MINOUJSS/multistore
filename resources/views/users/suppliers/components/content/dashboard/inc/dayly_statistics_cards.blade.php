    ...
    <div class="col-sm-12 col-md-6 col-lg-3">
        <div class="card border-0 shadow-sm rounded-4 h-100 bg-white dashboard-stat-card">
            <div class="card-body p-3">
                ...
                <h3 class="fw-bold mb-0 text-dark">{{ $supplier->orderToDay->count() }}</h3>
            </div>
        </div>
    </div>
    <div class="col-sm-12 col-md-6 col-lg-3">
        <div class="card border-0 shadow-sm rounded-4 h-100 bg-white dashboard-stat-card">
            <div class="card-body p-3">
                ...
                <h3 class="fw-bold mb-0 text-dark">{{ $supplier->orderConfirmedToDay->count() }}</h3>
            </div>
        </div>
    </div>
    <div class="col-sm-12 col-md-6 col-lg-3">
        <div class="card border-0 shadow-sm rounded-4 h-100 bg-white dashboard-stat-card">
            <div class="card-body p-3">
                ...
                <h3 class="fw-bold mb-0 text-dark">{{ $supplier->orderCanceledToDay->count() }}</h3>
            </div>
        </div>
    </div>
    <div class="col-sm-12 col-md-6 col-lg-3">
        <a class="text-decoration-none" href="{{ route('supplier.orders-abandoned') }}">
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white dashboard-stat-card">
                <div class="card-body p-3">
                    ...
                    <h3 class="fw-bold mb-0 text-dark">{{ $supplier->orderAbandonedToDay->count() }}</h3>
                </div>
            </div>
        </a>
    </div>
