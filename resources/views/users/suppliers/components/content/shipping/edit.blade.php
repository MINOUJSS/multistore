        ...
        <div class="row align-items-center position-relative z-1">
            <div class="col-lg-8 mb-3 mb-lg-0">
                <div
                    ...
                    <span class="fw-semibold">{{ __('إدارة تسعير وولايات شحن التوريد') }}</span>
                    <span class="opacity-50">|</span>
                    <span class="opacity-90">{{ now()->locale('ar')->translatedFormat('l، j F Y') }}</span>
                </div>
                <h1 class="display-6 fw-bold mb-2 text-white text-start">
                    تسعير الشحن والتوصيل لولايات التوريد 🚚
                </h1>
                <p class="text-white-50 mb-0 leading-relaxed fs-6">
                    ضبط أسعار الشحن المنزلي والمكتبي، التكاليف الإضافية وتفعيل التوصيل لكل ولاية من الولايات الـ 58 بطريقة سلسة ومنظمة.
                </p>
            </div>
            <div class="col-lg-4 text-lg-end">
                <div class="d-flex flex-wrap gap-2 justify-content-lg-end">
                    <a href="{{ route('supplier.shipping') }}"
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white hover-lift transition-all">
                <div class="card-body p-3.5">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <span class="badge bg-info-subtle text-info rounded-pill small">لمنزل</span>
                    </div>
                    <h3 class="fw-bold mb-1 text-dark fs-4">
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4 bg-white">
        <div
            ...
            <div class="d-flex flex-wrap align-items-center gap-2">
                ...
                <h5 class="fw-bold mb-0 text-dark fs-6">جدول أسعار شحن التوريد لولايات الوطن</h5>
            </div>
            <span class="badge bg-light text-dark border px-3 py-1.5 rounded-pill small fw-semibold">
                <i class="fa-solid fa-truck-moving me-1 text-navy"></i> 58 ولاية
            </span>
        </div>
        <div class="card-body p-0 p-md-3">
            <form action="{{ route('supplier.shipping.update') }}" method="POST">
                                ...
                                <tr>
                                    ...
                                    <td data-label="الولاية">
                                        <span class="fw-bold text-dark fs-6 d-inline-flex align-items-center gap-1.5">
                                            <i class="fa-solid fa-location-dot text-navy"></i>
                ...
                <div
                    ...
                    <button type="submit"
                        class="btn btn-supplier-primary rounded-3 px-4 py-2.5 fw-bold shadow-sm d-inline-flex align-items-center gap-2">
