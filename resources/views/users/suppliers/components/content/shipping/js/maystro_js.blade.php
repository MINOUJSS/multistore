<script>
    $(document).ready(function () {
        ...
        //--------
        $("#MAYSTRO_DELIVERYModal").on("show.bs.modal", function () {
        ...
        //------------
    $("#MAYSTRO_DELIVERYForm").submit(function (event) {
        ...
        $.ajax({
            ...
            //--------------------
        $("#testMAYSTRO_DELIVERYConnection").on("click", function() {
            let formData = $("#MAYSTRO_DELIVERYForm").serialize();
