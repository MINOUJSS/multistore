    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4 bg-white">
        <div
            ...
            <span class="badge bg-light text-dark border px-3 py-1.5 rounded-pill small fw-semibold">
                <i class="fa-solid fa-layer-group me-1 text-navy"></i> إجمالي المعروض: {{ $products->count() }} منتج
            </span>
        </div>
                        ...
                        @foreach ($products as $product)
                            <tr>
                                ...
                                <td data-label="أقل كمية للطلب"><span
                                        ...
                                        قطع</span></td>
                                <td data-label="التوصيل المجاني">{!! s_p_has_free_shipping($product->id) == 'نعم'
                                ...
                                <td data-label="الإجراءات" class="pe-md-4 text-end">
                                    <button value="{{ $product->id }}"
                                        class="btn btn-sm btn-outline-primary rounded-3 editproduct px-2.5 py-1 me-1 shadow-2xs fw-semibold"
