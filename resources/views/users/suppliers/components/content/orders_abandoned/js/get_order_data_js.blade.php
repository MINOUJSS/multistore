...
//--- دالة طباعة الفاتورة الشاملة للطلبيات المتروكة للمورد ---
function printInvoice() {
    ...
    const invoiceHtml = `
        ...
        <head>
            <meta charset="UTF-8">
            <title>فاتورة طلبية توريد متروكة #${orderNumber}</title>
        ...
        <body>
            ...
            <div class="invoice-card">
                ...
                <div class="invoice-header d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="invoice-title mb-1">فاتورة طلبية توريد متروكة <span style="color:#0f172a;">#${orderNumber}</span></h2>
                        <span class="text-muted small">تاريخ الاصدار: ${new Date().toLocaleDateString('ar-DZ')}</span>
                    </div>
                    <div class="text-end">
                        <span class="badge-abandoned fw-bold">
                            حالة الطلب: طلبية توريد غير مكتملة
                        </span>
                    </div>
                </div>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-6">
                        <div class="info-box h-100">
                            <h6><i class="fa-solid fa-user me-1 text-primary"></i> معلومات العميل/التاجر</h6>
                    ...
                    <div class="col-6">
                        <div class="info-box h-100">
                            <h6><i class="fa-solid fa-location-dot me-1 text-primary"></i> معلومات الشحن والتوصيل</h6>
                ...
                <!-- Products Table -->
                <h5 class="fw-bold mb-2"><i class="fa-solid fa-boxes-packing me-2 text-primary"></i> تفاصيل بضائع التوريد</h5>
                <table class="table-invoice">
                    ...
                    <tfoot>
                        ...
                        <tr style="font-size:1.1rem; color:#0f172a;">
                            ...
                            <td class="text-end fw-bold" style="color:#0f172a;">${totalPrice}</td>
                        </tr>
                    </tfoot>
                </table>
                ...
                <div class="text-center mt-5 pt-3 border-top text-muted small">
                    <p class="mb-0 fw-semibold">شكراً لتعاملكم معنا ✨</p>
                </div>
            </div>
