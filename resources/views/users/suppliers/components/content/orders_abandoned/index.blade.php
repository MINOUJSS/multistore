        ...
        <div class="row align-items-center position-relative z-1">
            <div class="col-lg-8 mb-3 mb-lg-0">
                ...
                <p class="text-white-50 mb-0 leading-relaxed fs-6">
                    متابعة طلبيات التوريد بالجملة غير المكتملة للتجّار والبائعين، وإعادة التواصل لتنشيط وإتمام التوريد
                    بطريقة عصرية وسلسة.
                </p>
            </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white dashboard-stat-card">
                <div class="card-body p-3">
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        ...
                        <span
                            class="badge bg-navy-subtle text-navy px-2 py-1 rounded-pill fw-semibold small">الكل</span>
                    </div>
                    <h6 class="text-muted fw-semibold small mb-1">كل طلبات التوريد</h6>
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white dashboard-stat-card">
                <div class="card-body p-3">
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        ...
                        <span
                            class="badge bg-primary-subtle text-primary px-2 py-1 rounded-pill fw-semibold small">اليوم</span>
                    </div>
        ...
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            <div class="modal-header bg-navy text-white px-4 py-3 border-0"
                ...
                <h5 class="modal-title fw-bold fs-6 d-flex align-items-center gap-2">
                    ...
                    <span>تفاصيل طلب التوريد المتروك</span>
            ...
            <div class="modal-body p-4">
                ...
                <h6 class="fw-bold text-dark mb-3 mt-4">
                    <i class="fa-solid fa-boxes-packing me-1 text-navy"></i> قائمة المنتجات
                </h6>
                <div class="table-responsive rounded-3 border">
                    <table class="table table-bordered align-middle mb-0">
                        ...
                        <tfoot class="table-light fw-bold">
                            ...
                            <tr>
                                <td colspan="3" class="text-start text-navy">الإجمالي الكلي</td>
            ...
            <div class="modal-footer bg-light px-4 py-3 border-top-0">
                ...
                <button type="button"
                    class="btn btn-supplier-primary rounded-3 px-4 fw-bold shadow-sm d-flex align-items-center gap-2"
...
<!-- Modern CSS Styles for Supplier Panel -->
<style>
    :root {
        --supplier-navy: #0f172a;
        --supplier-navy-hover: #1e293b;
        --supplier-navy-dark: #020617;
    }
    ...
    .btn-supplier-primary {
        background: linear-gradient(135deg, var(--supplier-navy) 0%, var(--supplier-navy-hover) 100%);
    ...
    .btn-supplier-primary:hover {
        background: linear-gradient(135deg, var(--supplier-navy-dark) 0%, var(--supplier-navy) 100%);
        color: #ffffff !important;
