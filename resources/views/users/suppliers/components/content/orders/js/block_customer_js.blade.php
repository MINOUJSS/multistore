<script>
    function block_customer(order_id) {
        $.ajax({
            url: `/supplier-panel/customer-block-list/is-blocked/${order_id}`, // Adjust the route as needed
            method: "POST",
            headers: {
                ...
                if (response.status == 'blocked') {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                url: `/supplier-panel/customer-block-list/create/${order_id}`, // Adjust the route as needed
                                method: "POST",
                                headers: {
