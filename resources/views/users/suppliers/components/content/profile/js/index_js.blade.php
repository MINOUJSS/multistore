<script>
    $(document).ready(function() {
        ...
        document.getElementById('avatarInput')?.addEventListener('change', function(e) {
            ...
            fetch('/supplier-panel/profile/update-avatar', { // Replace with your actual endpoint
                    method: 'POST',
                    body: formData,
                    headers: {
    ...
    function fetchDayra(wilaya_id) {
        ...
        //
        $.ajax({
            url: "{{ route('supplier.get-dayras', ['wilaya_id' => ':id']) }}"
    ...
    function fetchBaladia(dayra_id) {
        ...
        //
        $.ajax({
            url: "{{ route('supplier.get-baladias', ['dayra_id' => ':id']) }}"
        .replace(':id', dayra_id),
            method: 'POST',
            success: function(response) {
                // console.log(response);
