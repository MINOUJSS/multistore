        ...
        <div class="row align-items-center position-relative z-1">
            <div class="col-lg-8 mb-3 mb-lg-0">
                <div
                    ...
                    <span class="fw-semibold">{{ __('إعدادات حساب التوريد والملف الشخصي') }}</span>
                    <span class="opacity-50">|</span>
                    <span class="opacity-90">{{ now()->locale('ar')->translatedFormat('l، j F Y') }}</span>
                </div>
                <h1 class="display-6 fw-bold mb-2 text-white text-start">
                    الملف الشخصي وإعدادات التوريد 👤
                </h1>
                <p class="text-white-50 mb-0 leading-relaxed fs-6">
                    إدارة بياناتك الشخصية، معلومات متجر التوريد، إعدادات الأمان، وتفاصيل حسابات الدفع والبنك.
                </p>
            </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 bg-white p-4 text-center sticky-top" style="top: 20px;">
                ...
                <div class="avatar-upload mb-3 position-relative mx-auto" style="width: 120px; height: 120px;">
                    ...
                    <button id="avataruploadbtn"
                        class="btn btn-supplier-primary position-absolute bottom-0 end-0 rounded-circle p-0 d-flex align-items-center justify-content-center shadow-sm"
                ...
                <!-- معلومات المستخدم -->
                <h5 class="fw-bold text-dark mb-1">{{ $supplier->full_name }}</h5>
                <p class="text-muted small mb-3">
                    <i class="fas fa-envelope me-1 text-navy"></i> {{ $user->email }}
                </p>

                <!-- مستوى اكتمال الملف (متوافق 100% مع progress_bar_js) -->
                ...
                @if ($supplier->approval_status != 'approved')
                    <div class="pt-2">
                        <form id="requestValidationForm" action="{{ route('supplier.profile.request.validation') }}" method="POST">
                            @csrf
                        </form>
                        <button id="submit-validation-request" type="submit" class="btn btn-supplier-primary w-100 rounded-3 py-2 fw-bold shadow-sm">
                    ...
                    <ul class="nav nav-pills gap-2" id="profile-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link rounded-3 fw-bold px-3.5 py-2.5 active" id="personal-tab" data-bs-toggle="pill"
                                ...
                                <i class="fas fa-user me-1.5 text-navy"></i> المعلومات الأساسية
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                ...
                <div class="card-body p-4 p-md-5">
                    <div class="tab-content" id="profile-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="personal" role="tabpanel">
                            <form action="{{ route('supplier.profile.update') }}" method="POST" class="row g-4" enctype="multipart/form-data">
                                @csrf
                                <div class="col-12 col-md-6">
                                    <label class="form-label fw-bold text-dark small">الاسم الكامل</label>
                                    <div class="input-group">
                                        <span class="input-group-text bg-light border-end-0"><i class="fas fa-user text-muted"></i></span>
                                        <input name="full_name" type="text" class="form-control border-start-0" value="{{ $supplier->full_name }}">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="last_name" type="text" class="form-control border-start-0" value="{{ $supplier->last_name }}">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text bg-light border-end-0"><i class="fas fa-user text-muted"></i></span>
                                        <input name="first_name" type="text" class="form-control border-start-0" value="{{ $supplier->first_name }}">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-select border-start-0" name="sex" id="sex">
                                            ...
                                            <option value="male" {{ $supplier->sex == 'male' ? 'selected' : '' }}>ذكر</option>
                                            <option value="female" {{ $supplier->sex == 'female' ? 'selected' : '' }}>انثى</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" class="form-control border-start-0" name="birth_date" id="birth_date"
                                            value="{{ $supplier->birth_date ?? '' }}" max="{{ now()->format('Y-m-d') }}">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="store_name" class="form-control border-start-0" value="{{ $supplier->store_name }}">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                        ...
                                        <select id="inputWilaya" name="wilaya" class="form-select border-start-0 @error('wilaya') is-invalid @enderror">
                                            ...
                                            @foreach ($wilayas as $wilaya)
                                                <option value="{{ $wilaya->id }}"
                                                    {{ old('wilaya', $supplier->wilaya) == $wilaya->id ? 'selected' : '' }}>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select id="inputDayra" name="dayra" class="form-select border-start-0 @error('dayra') is-invalid @enderror">
                                            ...
                                            @php
                                                $supplierDayra = (!empty($supplier->dayra) && $supplier->dayra !== 'null' && is_numeric($supplier->dayra))
                                                    ? \App\Models\Dayra::find($supplier->dayra)
                                                    : null;
                                            @endphp
                                            @if ($supplierDayra)
                                                <option value="{{ $supplierDayra->id }}" selected>
                                                    {{ $supplierDayra->ar_name }}</option>
                                            @endif
                                        </select>
                                        @error('dayra')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select id="inputBaladia" class="form-select border-start-0" name="baladia">
                                            <option value="null">غير محددة</option>
                                            @php
                                                $supplierBaladia = (!empty($supplier->baladia) && $supplier->baladia !== 'null' && is_numeric($supplier->baladia))
                                                    ? \App\Models\Baladia::find($supplier->baladia)
                                                    : null;
                                            @endphp
                                            @if ($supplierBaladia)
                                                <option value="{{ $supplierBaladia->id }}" selected>
                                                    {{ $supplierBaladia->ar_name }}</option>
                                            @endif
                                        </select>
                                    </div>
                                </div>
                                <div class="col-12">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text bg-light border-end-0"><i class="fas fa-map-marked-alt text-muted"></i></span>
                                        <textarea name="address" class="form-control border-start-0" rows="3" placeholder="العنوان التفصيلي...">{{ $supplier->address }}</textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                ...
                                @if ($supplier->id_card_image != null)
                                    <div class="col-12 text-center">
                                        <div class="p-2 border rounded-4 bg-light-subtle d-inline-block shadow-sm">
                                            <img src="{{ $supplier->id_card_image }}" alt="وثيقة الهوية" class="img-fluid rounded-3" style="max-height: 200px; object-fit: contain;">
                                        </div>
                                    </div>
                                @endif
                        ...
                        <div class="tab-pane fade" id="security" role="tabpanel">
                            <form action="{{ route('supplier.profile.password.update') }}" method="POST" class="row g-4">
                                @csrf
                                <div class="col-12">
                                    <div class="alert alert-info border-0 rounded-3 bg-navy-subtle text-navy p-3">
                        ...
                        <div class="tab-pane fade" id="chargily" role="tabpanel">
                            <form action="{{ route('supplier.profile.chargily-settings.update') }}" method="POST" class="row g-4">
                                @csrf
                                <div class="col-12 col-md-6">
                                ...
                                <div class="col-12">
                                    <button type="submit" class="btn btn-supplier-primary w-100 rounded-3 py-2.5 fw-bold shadow-sm">
                                        <i class="fas fa-save me-1"></i> حفظ إعدادات Chargily
                                    </button>
                                </div>
                            </form>
                            @if ($chargily_settings != null)
                                <form action="{{ route('supplier.profile.chargily-settings.delete') }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                        ...
                        <div class="tab-pane fade" id="bank" role="tabpanel">
                            <form action="{{ route('supplier.profile.bank-settings.update') }}" method="POST" class="row g-4">
                                @csrf
                                <div class="col-12 col-md-6">
                            ...
                            @if ($bank_settings != null)
                                <form action="{{ route('supplier.profile.bank-settings.delete') }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-outline-danger w-100 rounded-3 py-2.5 fw-bold mt-3"
