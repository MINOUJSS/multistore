        ...
        <div class="row align-items-center position-relative z-1">
            <div class="col-lg-7 mb-3 mb-lg-0">
                <div
                    ...
                    <span class="fw-semibold">{{ __('تفاصيل وثيقة الفاتورة للتوريد') }}</span>
                ...
                <p class="text-white-50 mb-0 leading-relaxed fs-6">
                    معاينة شاملة لبنود الفاتورة والمبالغ المستحقة وطريقة السداد المعنية بحساب التوريد.
                </p>
            </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden bg-white p-4 p-md-5 mb-4 invoice-card-print">
                ...
                <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 border-bottom pb-4 mb-4">
                    <div>
                        <div class="d-flex align-items-center gap-2 mb-2">
                            ...
                            <h3 class="fw-bold mb-0 text-dark">فاتورة توريد رسمية</h3>
                        </div>
                        ...
                        <div class="text-secondary small">
                            <span class="fw-semibold">تاريخ الإصدار:</span>
                    ...
                    <div class="text-lg-end bg-light-subtle rounded-3 p-3 border">
                        ...
                        <div class="text-secondary small">
                            ...
                            <span class="fw-bold text-navy">{{ $invoice->payment_method }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-end">
                    <div class="col-12 col-md-6 col-lg-5">
                        <div class="p-3.5 rounded-4 bg-navy-subtle border border-navy-subtle text-center">
