        ...
        <div class="row align-items-center position-relative z-1">
            <div class="col-lg-8 mb-3 mb-lg-0">
                <div
                    ...
                    <span class="fw-semibold">{{ __('الدفع الإلكتروني عبر بريدي موب (اشتراك توريد جديد)') }}</span>
                    <span class="opacity-50">|</span>
                    <span class="opacity-90">{{ now()->locale('ar')->translatedFormat('l، j F Y') }}</span>
                </div>
                <h1 class="display-6 fw-bold mb-2 text-white text-start">
                    الدفع عبر تطبيق بريدي موب للتوريد 📱
                </h1>
                <p class="text-white-50 mb-0 leading-relaxed fs-6">
                    قم بتحويل قيمة تفعيل الخطة عبر تطبيق BaridiMob ورفع صورة الإثبات لإكمال طلب اشتراك التوريد الجديد.
                </p>
            </div>
        ...
        <div class="col-12 col-lg-8 col-xl-7">
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden bg-white text-center p-4 p-md-5 mb-4">
                <div class="p-3 bg-light rounded-4 mb-4 d-inline-block">
                    <img src="{{ asset('asset/v1/users/dashboard/img/payments/baridimaobe.png') }}" alt="Baridimob"
                        class="img-fluid" style="max-height: 100px; object-fit: contain;">
                </div>
                <h4 class="fw-bold text-dark mb-2">الدفع عبر تطبيق BaridiMob</h4>
                <p class="text-muted small mb-4">
                    سيتم معالجة وتأكيد اشتراكك الجديد فور استلام ورفع إثبات التحويل.
                </p>
                ...
                @include('users.suppliers.components.content.payments.inc.admin_account_card', ['type' => 'baridimob'])

                <!-- نموذج الدفع ورفع الإثبات -->
                <form action="{{ route('supplier.new.subscription.payment.baridimob') }}" method="POST" enctype="multipart/form-data" class="text-start">
                    @csrf
                    ...
                    <button type="submit"
                        ...
                        <span>تأكيد وإرسال إيصال الدفع عبر Baridimob</span>
                    </button>
                </form>
            </div>
        </div>
