        ...
        <div class="row align-items-center position-relative z-1">
            <div class="col-lg-8 mb-3 mb-lg-0">
                <div
                    ...
                    <span class="fw-semibold">{{ __('الدفع البريدي عبر CCP للفاتورة (التوريد)') }}</span>
                    <span class="opacity-50">|</span>
                    <span class="opacity-90">{{ now()->locale('ar')->translatedFormat('l، j F Y') }}</span>
                </div>
                <h1 class="display-6 fw-bold mb-2 text-white text-start">
                    بيانات الدفع عبر بريد الجزائر CCP للتوريد 🏛️
                </h1>
                <p class="text-white-50 mb-0 leading-relaxed fs-6">
                    يرجى تحويل مبلغ الفاتورة عبر مكاتب بريد الجزائر CCP ورفع صورة إيصال الدفع أدناه لإكمال وتسديد الفاتورة.
                </p>
            </div>
            <div class="col-lg-4 text-lg-end">
                <a href="{{ route('supplier.billing.invoices') }}"
        ...
        <div class="col-12 col-lg-8 col-xl-7">
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden bg-white text-center p-4 p-md-5 mb-4">
                <div class="p-3 bg-light rounded-4 mb-4 d-inline-block">
                    <img src="{{ asset('asset/v1/users/dashboard/img/payments/algerie post.png') }}" alt="بريد الجزائر CCP"
                ...
                <p class="text-muted small mb-4">
                    يرجى الدفع عبر الحساب البريدي الجاري CCP ورفع إيصال الدفع أدناه للتحقق من السداد.
                </p>

                <!-- معلومات الفاتورة -->
                <div class="text-start bg-light-subtle rounded-4 p-4 border mb-4">
                    <h6 class="fw-bold text-navy mb-3 border-bottom pb-2">
                        <i class="fa-solid fa-file-invoice me-1"></i> ملخص معلومات الفاتورة:
                    </h6>
                    <div class="d-flex justify-content-between align-items-center mb-2.5 pb-2 border-bottom">
                        ...
                        <span class="fw-bold text-dark font-monospace fs-6">#{{ $invoice->invoice_number ?? 'غير متوفر' }}</span>
                    </div>
                    <div class="d-flex justify-content-between align-items-center mb-2.5 pb-2 border-bottom">
                        <span class="text-muted small">تاريخ الإصدار:</span>
                        <span class="fw-bold text-dark small">{{ $invoice->created_at }}</span>
                    </div>
                    <div class="d-flex justify-content-between align-items-center mb-2.5 pb-2 border-bottom">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <span class="text-muted small">حالة الفاتورة:</span>
                ...
                @include('users.suppliers.components.content.payments.inc.admin_account_card', ['type' => 'ccp'])
                ...
                <form action="{{ route('supplier.billing.invoice.pay') }}" method="POST" enctype="multipart/form-data" class="text-start">
                    ...
                    <div class="mb-4">
                        <label for="payment_proof" class="form-label fw-bold text-dark small">
                            <i class="fa-solid fa-cloud-arrow-up text-navy me-1"></i> رفع إيصال الدفع البريدي <span class="text-danger">*</span>
                        </label>
                    ...
                    <button type="submit"
                        ...
                        <span>إرسال وتأكيد إيصال الدفع عبر CCP</span>
                    </button>
                </form>
            </div>
        </div>
