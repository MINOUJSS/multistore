        ...
        <div class="row align-items-center position-relative z-1">
            <div class="col-lg-8 mb-3 mb-lg-0">
                <div
                    ...
                    <span class="fw-semibold">{{ __('الدفع الإلكتروني عبر CIB / البطاقة الذهبية للفاتورة (التوريد)') }}</span>
                    <span class="opacity-50">|</span>
                    <span class="opacity-90">{{ now()->locale('ar')->translatedFormat('l، j F Y') }}</span>
                </div>
                <h1 class="display-6 fw-bold mb-2 text-white text-start">
                    بيانات الدفع عبر البطاقة البنكية للتوريد 💳
                </h1>
                <p class="text-white-50 mb-0 leading-relaxed fs-6">
                    تسديد فوري وآمن لمبلغ الفاتورة عبر بوابة ChargilyPay باستعمال البطاقة الذهبية أو بطاقة CIB.
                </p>
            </div>
        ...
        <div class="col-12 col-lg-8 col-xl-7">
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden bg-white text-center p-4 p-md-5 mb-4">
                <div class="p-3 bg-light rounded-4 mb-4 d-inline-block">
                    <img src="{{ asset('asset/v1/users/dashboard/img/payments/eldhahabia.png') }}" alt="الدفع بالبطاقة البنكية"
                ...
                <p class="text-muted small mb-4">
                    يرجى الضغط على زر التوجيه والدفع أدناه للتسديد المباشر عبر بوابة ChargilyPay الآمنة.
                </p>
                ...
                <form action="{{ route('supplier.chargilypay.redirect') }}" method="POST" enctype="multipart/form-data" class="text-start">
                    @csrf
                    ...
                    <button type="submit"
                        ...
                        <span>الانتقال لبوابة الدفع الإلكتروني والإنهاء</span>
                    </button>
                </form>
            </div>
        </div>
