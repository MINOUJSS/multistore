<div class="container-fluid py-3 px-3 px-md-4">
        ...
        <div class="row align-items-center position-relative z-1">
            <div class="col-lg-7 mb-3 mb-lg-0">
                <div
                    ...
                    <span class="fw-semibold">{{ __('إشعارات التوريد والطلبات الفورية') }}</span>
                    <span class="opacity-50">|</span>
                    <span class="opacity-90">{{ now()->locale('ar')->translatedFormat('l، j F Y') }}</span>
                </div>
                <h1 class="display-6 fw-bold mb-2 text-white text-start">
                    إعدادات إشعارات التليجرام Telegram للتوريد ✈️
                </h1>
                <p class="text-white-50 mb-0 leading-relaxed fs-6">
                    استقبل إشعارات فورية بكل طلب تويرد جديد وحركة مخزون على حسابك في تليجرام لتبقى على اطلاع دائم.
                </p>
            </div>
            <div class="col-lg-5 text-lg-end">
                <div class="d-flex flex-wrap gap-2 justify-content-lg-end">
                    <a href="https://t.me/MinouDZShopbot?start=start" target="_blank"
                        class="btn btn-info text-white fw-bold px-3.5 py-2.5 rounded-3 border-0 shadow-sm d-inline-flex align-items-center gap-2"
                        style="background: #0088cc !important;">
                        <i class="fab fa-telegram fs-5"></i>
                        <span>ربط حساب التليجرام</span>
                    </a>
                    <a href="{{ route('supplier.apps') }}"
                    ...
                    <button
                        ...
                        data-bs-toggle="modal" data-bs-target="#addTelegramModal"
                        @if (($plan_id == 1 && $apps_count >= 1) || ($plan_id == 2 && $apps_count >= 1) || ($plan_id == 3 && $apps_count >= 1)) disabled @endif>
                        <i class="fas fa-plus"></i>
                        <span>إضافة Chat ID</span>
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="row g-3 mb-4">
        <!-- 1. Total Configured Telegram Chats -->
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white hover-lift transition-all">
                <div class="card-body p-3.5">
                    ...
                    <h3 class="fw-bold mb-1 text-dark fs-4">{{ $telegramSettings->count() }}</h3>
                    <p class="text-muted small mb-0 fw-semibold">إجمالي الـ Chat IDs المضافة</p>
                </div>
            </div>
        </div>

        <!-- 2. Active Telegram Chats -->
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white hover-lift transition-all">
                <div class="card-body p-3.5">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                    ...
                    <h3 class="fw-bold mb-1 text-dark fs-4">{{ $telegramSettings->where('status', 'active')->count() }}</h3>
                    <p class="text-muted small mb-0 fw-semibold">إشعارات التليجرام المفعلة</p>
                </div>
            </div>
        </div>

        <!-- 3. Inactive Telegram Chats -->
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white hover-lift transition-all">
                <div class="card-body p-3.5">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                    ...
                    <h3 class="fw-bold mb-1 text-dark fs-4">{{ $telegramSettings->where('status', '!=', 'active')->count() }}</h3>
                    <p class="text-muted small mb-0 fw-semibold">إشعارات التليجرام المعطلة</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white hover-lift transition-all">
                <div class="card-body p-3.5">
                    ...
                    <h3 class="fw-bold mb-1 text-dark fs-4">1</h3>
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4 bg-white">
        <div
            ...
            <div class="d-flex flex-wrap align-items-center gap-2">
                <span class="avatar avatar-md rounded-3 bg-navy-subtle text-navy fw-bold me-1"
                    ...
                    <i class="fab fa-telegram fs-6"></i>
                </span>
                <h5 class="fw-bold mb-0 text-dark fs-6">قائمة إعدادات إشعارات Telegram للتوريد</h5>
            </div>
            <div class="d-flex align-items-center gap-2">
                <a href="https://t.me/MinouDZShopbot?start=start" target="_blank"
                    class="btn btn-outline-info rounded-3 px-3 py-2 fs-6 fw-bold d-inline-flex align-items-center gap-2">
                    <i class="fab fa-telegram"></i>
                    <span>ربط الحساب</span>
                </a>
                <button
                    class="btn btn-supplier-primary rounded-3 px-3 py-2 fs-6 fw-bold shadow-sm d-inline-flex align-items-center gap-2"
                    data-bs-toggle="modal" data-bs-target="#addTelegramModal"
                    @if (($plan_id == 1 && $apps_count >= 1) || ($plan_id == 2 && $apps_count >= 1) || ($plan_id == 3 && $apps_count >= 1)) disabled @endif>
                    <i class="fas fa-plus"></i>
                    <span>إضافة Chat ID</span>
        ...
        <div class="card-body p-0 p-md-3">
            <div class="table-responsive telegram-table-responsive custom-table-scroll">
                <table class="table table-hover align-middle mb-0 telegram-table">
                    <thead class="bg-light-subtle text-secondary small text-uppercase fw-bold border-bottom">
                        <tr>
                            ...
                            <th class="text-nowrap">معرف الـ Chat في Telegram</th>
                    ...
                    <tbody>
                        @foreach ($telegramSettings as $index => $telegram)
                            <tr id="row-{{ $telegram->id }}">
                                ...
                                <td data-label="معرف الـ Chat في Telegram">
                                    <div class="d-flex align-items-center gap-2">
                                        <span class="avatar avatar-xs rounded-circle text-white fw-bold me-1"
                                            style="width: 28px; height: 28px; display: inline-flex; align-items: center; justify-content: center; font-size: 11px; background-color: #0088cc;">
                                            <i class="fab fa-telegram-plane"></i>
                                        </span>
                                        <span class="fw-bold text-dark font-monospace fs-6">
                                            {{ json_decode($telegram->data)->chat_id }}
                                        </span>
                                    </div>
                                </td>
                                <td data-label="الحالة" class="text-center">
                                    <span
                                        class="badge {{ $telegram->status === 'active' ? 'bg-success-subtle text-success border border-success' : 'bg-secondary-subtle text-secondary border border-secondary' }} rounded-pill px-3 py-1.5 fw-semibold">
...
<div class="modal fade" id="addTelegramModal" tabindex="-1" aria-labelledby="addTelegramModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            <div class="modal-header text-white py-3.5 px-4"
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <h5 class="modal-title fw-bold mb-0 fs-6 text-white" id="addTelegramModalLabel">إضافة إعدادات إشعارات Telegram</h5>
                </div>
            ...
            <div class="modal-body p-4 bg-white">
                <form id="AddTelegramNotificationForm">
                    ...
                    <div class="mb-3.5">
                        <label class="form-label fw-bold text-dark small">معرف الـ Chat في Telegram <span
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="chat_id" id="chat_id"
                                ...
                                placeholder="أدخل معرف الـ Chat">
                        </div>
                        <div class="invalid-feedback d-block mt-1 small" id="error-chat_id"></div>
                    </div>

                    <div class="p-3 bg-light rounded-3 border mb-4">
                        <div class="form-check form-switch d-flex align-items-center justify-content-between p-0 mb-0">
                            <label class="form-check-label fw-bold text-dark small mb-0" for="status">تفعيل الإشعارات تلقائيًا</label>
                    ...
                    <button type="submit"
                        ...
                        <span>حفظ وإضافة الإعدادات</span>
                    </button>
                </form>
            </div>
        </div>
        ...
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            <div class="modal-header text-white py-3.5 px-4"
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <h5 class="modal-title fw-bold mb-0 fs-6 text-white" id="editTelegramModalLabel">تعديل إعدادات إشعارات Telegram</h5>
                </div>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                    aria-label="إغلاق"></button>
            </div>
            <div class="modal-body p-4 bg-white">
                <form id="EditTelegramNotificationForm">
                    ...
                    <div class="p-3 bg-light rounded-3 border mb-4">
                        <div class="form-check form-switch d-flex align-items-center justify-content-between p-0 mb-0">
                            <label class="form-check-label fw-bold text-dark small mb-0" for="edit_status">تفعيل الإشعارات</label>
                            <input class="form-check-input ms-0 shadow-none" type="checkbox" name="status"
...
<style>
    ...
    @media (max-width: 1024.98px) {
        ...
        .telegram-table-responsive table.telegram-table,
        .telegram-table-responsive table.telegram-table tbody,
        .telegram-table-responsive table.telegram-table tr,
        .telegram-table-responsive table.telegram-table td,
        .telegram-table-responsive table.telegram-table th {
            display: block !important;
            width: 100% !important;
            box-sizing: border-box !important;
        }

        .telegram-table-responsive table.telegram-table thead {
            display: none !important;
        }

        .telegram-table-responsive table.telegram-table tbody tr {
        ...
        .telegram-table-responsive table.telegram-table tbody tr:hover {
            box-shadow: 0 8px 20px rgba(0, 0, 0, 0.08) !important;
        }

        .telegram-table-responsive table.telegram-table tbody td,
        .telegram-table-responsive table.telegram-table tbody th {
        ...
        .telegram-table-responsive table.telegram-table tbody td:last-child {
            border-bottom: none !important;
        }

        .telegram-table-responsive table.telegram-table tbody td::before,
        .telegram-table-responsive table.telegram-table tbody th::before {
    ...
    @media (min-width: 768px) and (max-width: 1024.98px) {
        ...
        .telegram-table-responsive table.telegram-table tbody th[data-label="#"] {
            grid-column: 1 / -1;
            border-bottom: 1px solid #e2e8f0 !important;
            padding-bottom: 0.5rem !important;
        }

        .telegram-table-responsive table.telegram-table tbody td[data-label="الإجراء"] {
            grid-column: 1 / -1;
            border-bottom: none !important;
