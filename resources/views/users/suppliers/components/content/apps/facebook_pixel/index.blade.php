        ...
        <div class="row align-items-center position-relative z-1">
            <div class="col-lg-8 mb-3 mb-lg-0">
                <div
                    ...
                    <span class="fw-semibold">{{ __('إدارة بكسل الإعلانات للتوريد') }}</span>
                    <span class="opacity-50">|</span>
                    <span class="opacity-90">{{ now()->locale('ar')->translatedFormat('l، j F Y') }}</span>
                </div>
                <h1 class="display-6 fw-bold mb-2 text-white text-start">
                    إعدادات بكسل فيسبوك Facebook Pixel للتوريد 📘
                </h1>
            ...
            <div class="col-lg-4 text-lg-end">
                <div class="d-flex flex-wrap gap-2 justify-content-lg-end">
                    ...
                    <button id="add_btn"
                        ...
                        @if (($plan_id == 1 && $apps_count >= 1) || ($plan_id == 2 && $apps_count >= 2) || ($plan_id == 3 && $apps_count >= 4)) disabled @endif>
        ...
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white hover-lift transition-all">
                <div class="card-body p-3.5">
                    ...
                    <p class="text-muted small mb-0 fw-semibold">بكسلات فيسبوك المفعلة</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white hover-lift transition-all">
                <div class="card-body p-3.5">
                    ...
                    <h3 class="fw-bold mb-1 text-dark fs-4">{{ $pixels->where('status', '!=', 'active')->count() }}</h3>
                    <p class="text-muted small mb-0 fw-semibold">بكسلات فيسبوك المعطلة</p>
                </div>
            </div>
        </div>
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4 bg-white">
        <div
            ...
            <div class="d-flex flex-wrap align-items-center gap-2">
                ...
                <h5 class="fw-bold mb-0 text-dark fs-6">قائمة بكسلات فيسبوك Facebook Pixel للتوريد</h5>
            </div>
            <button
        ...
        <div class="card-body p-0 p-md-3">
            <div class="table-responsive facebook-pixel-table-responsive custom-table-scroll">
                <table class="table table-hover align-middle mb-0 facebook-pixel-table">
        ...
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            <div class="modal-header text-white py-3.5 px-4"
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <h5 class="modal-title fw-bold mb-0 fs-6 text-white" id="addPixelModalLabel">إضافة إعدادات Facebook Pixel</h5>
                </div>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                    aria-label="إغلاق"></button>
            </div>
            <div class="modal-body p-4 bg-white">
                <form id="AddFacebookPixelForm">
                    ...
                    <div class="p-3 bg-light rounded-3 border mb-4">
                        <div class="form-check form-switch d-flex align-items-center justify-content-between p-0 mb-0">
                            <label class="form-check-label fw-bold text-dark small mb-0" for="status">تفعيل البكسل تلقائيًا</label>
        ...
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            <div class="modal-header text-white py-3.5 px-4"
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <h5 class="modal-title fw-bold mb-0 fs-6 text-white" id="editPixelModalLabel">تعديل إعدادات Facebook Pixel</h5>
                </div>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                    aria-label="إغلاق"></button>
            </div>
            <div class="modal-body p-4 bg-white">
                <form id="EditFacebookPixelForm">
                    ...
                    <div class="p-3 bg-light rounded-3 border mb-4">
                        <div class="form-check form-switch d-flex align-items-center justify-content-between p-0 mb-0">
                            <label class="form-check-label fw-bold text-dark small mb-0" for="edit_status">تفعيل البكسل</label>
                            <input class="form-check-input ms-0 shadow-none" type="checkbox" name="status"
...
<style>
    ...
    @media (max-width: 1024.98px) {
        ...
        .facebook-pixel-table-responsive table.facebook-pixel-table,
        .facebook-pixel-table-responsive table.facebook-pixel-table tbody,
        .facebook-pixel-table-responsive table.facebook-pixel-table tr,
        .facebook-pixel-table-responsive table.facebook-pixel-table td,
        .facebook-pixel-table-responsive table.facebook-pixel-table th {
            display: block !important;
            width: 100% !important;
            box-sizing: border-box !important;
        }

        .facebook-pixel-table-responsive table.facebook-pixel-table thead {
            display: none !important;
        }

        .facebook-pixel-table-responsive table.facebook-pixel-table tbody tr {
        ...
        .facebook-pixel-table-responsive table.facebook-pixel-table tbody tr:hover {
            box-shadow: 0 8px 20px rgba(0, 0, 0, 0.08) !important;
        }

        .facebook-pixel-table-responsive table.facebook-pixel-table tbody td,
        .facebook-pixel-table-responsive table.facebook-pixel-table tbody th {
        ...
        .facebook-pixel-table-responsive table.facebook-pixel-table tbody td:last-child {
            border-bottom: none !important;
        }

        .facebook-pixel-table-responsive table.facebook-pixel-table tbody td::before,
        .facebook-pixel-table-responsive table.facebook-pixel-table tbody th::before {
    ...
    @media (min-width: 768px) and (max-width: 1024.98px) {
        ...
        .facebook-pixel-table-responsive table.facebook-pixel-table tbody th[data-label="#"] {
            grid-column: 1 / -1;
            border-bottom: 1px solid #e2e8f0 !important;
            padding-bottom: 0.5rem !important;
        }

        .facebook-pixel-table-responsive table.facebook-pixel-table tbody td[data-label="الإجراء"] {
            grid-column: 1 / -1;
            border-bottom: none !important;
    ...
    @media (min-width: 1025px) {
        .facebook-pixel-table th {
            font-size: 0.82rem;
            letter-spacing: 0.3px;
            padding: 0.9rem 0.75rem;
        }

        .facebook-pixel-table td,
        .facebook-pixel-table th {
