<div class="container-fluid py-3 px-3 px-md-4">
        ...
        <div class="row align-items-center position-relative z-1">
            <div class="col-lg-8 mb-3 mb-lg-0">
                <div
                    ...
                    <span class="fw-semibold">{{ __('متجر التطبيقات والتكاملات للتوريد') }}</span>
                    <span class="opacity-50">|</span>
                    <span class="opacity-90">{{ now()->locale('ar')->translatedFormat('l، j F Y') }}</span>
                </div>
                <h1 class="display-6 fw-bold mb-2 text-white text-start">
                    متجر التطبيقات والتكاملات لمتجر التوريد 🧩
                </h1>
                <p class="text-white-50 mb-0 leading-relaxed fs-6">
                    ربط حساب التوريد بأدوات التحليل، البيكسل للإعلانات (Facebook, TikTok, Google)، المزامنة مع Google Sheets، وإشعارات Telegram.
                </p>
            </div>
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4 bg-white">
        <div class="card-header bg-white border-0 py-3.5 px-3 px-md-4 d-flex align-items-center gap-2 border-bottom border-light">
            ...
            <h5 class="fw-bold mb-0 text-dark fs-6">قائمة التطبيقات والتكاملات المتاحة للتوريد</h5>
        </div>
                ...
                <div class="col-12 col-sm-6 col-lg-4 d-flex align-items-stretch">
                    <div class="card border border-light-subtle shadow-sm rounded-4 h-100 w-100 overflow-hidden bg-white hover-lift transition-all d-flex flex-column">
                        ...
                        <div class="card-body p-4 d-flex flex-column flex-grow-1 justify-content-between">
                            ...
                            <div>
                                @if($plan_id != 1)
                                    <a href="{{ route('supplier.app.google-analytics') }}" class="btn btn-supplier-primary w-100 rounded-3 shadow-sm py-2.5 fw-bold d-inline-flex align-items-center justify-content-center gap-2">
                ...
                <div class="col-12 col-sm-6 col-lg-4 d-flex align-items-stretch">
                    <div class="card border border-light-subtle shadow-sm rounded-4 h-100 w-100 overflow-hidden bg-white hover-lift transition-all d-flex flex-column">
                        ...
                        <div class="card-body p-4 d-flex flex-column flex-grow-1 justify-content-between">
                            ...
                            <div>
                                <a href="{{ route('supplier.app.facebook-pixel') }}" class="btn btn-supplier-primary w-100 rounded-3 shadow-sm py-2.5 fw-bold d-inline-flex align-items-center justify-content-center gap-2">
                                    <i class="fa-solid fa-sliders"></i>
                                    <span>إدارة الإعدادات</span>
                                </a>
                            </div>
                ...
                <div class="col-12 col-sm-6 col-lg-4 d-flex align-items-stretch">
                    <div class="card border border-light-subtle shadow-sm rounded-4 h-100 w-100 overflow-hidden bg-white hover-lift transition-all d-flex flex-column">
                        ...
                        <div class="card-body p-4 d-flex flex-column flex-grow-1 justify-content-between">
                            ...
                            <div>
                                @if($plan_id != 1)
                                    <a href="{{ route('supplier.app.tiktok-pixel') }}" class="btn btn-supplier-primary w-100 rounded-3 shadow-sm py-2.5 fw-bold d-inline-flex align-items-center justify-content-center gap-2">
                                        <i class="fa-solid fa-sliders"></i>
                                        <span>إدارة الإعدادات</span>
                                    </a>
                                @else
                ...
                <div class="col-12 col-sm-6 col-lg-4 d-flex align-items-stretch">
                    <div class="card border border-light-subtle shadow-sm rounded-4 h-100 w-100 overflow-hidden bg-white hover-lift transition-all d-flex flex-column">
                        ...
                        <div class="card-body p-4 d-flex flex-column flex-grow-1 justify-content-between">
                            ...
                            <div>
                                @if($plan_id != 1)
                                    <a href="{{ route('supplier.app.google-sheet') }}" class="btn btn-supplier-primary w-100 rounded-3 shadow-sm py-2.5 fw-bold d-inline-flex align-items-center justify-content-center gap-2">
                                        <i class="fa-solid fa-sliders"></i>
                                        <span>إدارة الإعدادات</span>
                                    </a>
                                @else
                ...
                <div class="col-12 col-sm-6 col-lg-4 d-flex align-items-stretch">
                    <div class="card border border-light-subtle shadow-sm rounded-4 h-100 w-100 overflow-hidden bg-white hover-lift transition-all d-flex flex-column">
                        ...
                        <div class="card-body p-4 d-flex flex-column flex-grow-1 justify-content-between">
                            ...
                            <div>
                                <a href="{{ route('supplier.app.telegram-notifications') }}" class="btn btn-supplier-primary w-100 rounded-3 shadow-sm py-2.5 fw-bold d-inline-flex align-items-center justify-content-center gap-2">
                                    <i class="fa-solid fa-sliders"></i>
                                    <span>إدارة الإعدادات</span>
                                </a>
                            </div>
                ...
                <div class="col-12 col-sm-6 col-lg-4 d-flex align-items-stretch">
                    <div class="card border border-light-subtle shadow-sm rounded-4 h-100 w-100 overflow-hidden bg-white hover-lift transition-all d-flex flex-column">
                        ...
                        <div class="card-body p-4 d-flex flex-column flex-grow-1 justify-content-between">
                            ...
                            <div>
                                @if($plan_id != 1)
                                    <a href="{{ route('supplier.app.clarity') }}" class="btn btn-supplier-primary w-100 rounded-3 shadow-sm py-2.5 fw-bold d-inline-flex align-items-center justify-content-center gap-2">
                                        <i class="fa-solid fa-sliders"></i>
                                        <span>إدارة الإعدادات</span>
                                    </a>
                                @else
