<div class="container-fluid py-3 px-3 px-md-4">
        ...
        <div class="row align-items-center position-relative z-1">
            <div class="col-lg-8 mb-3 mb-lg-0">
                <div
                    ...
                    <span class="fw-semibold">{{ __('تحليل حركة الزوار وسلوك المستخدمين للتوريد') }}</span>
                    <span class="opacity-50">|</span>
                    <span class="opacity-90">{{ now()->locale('ar')->translatedFormat('l، j F Y') }}</span>
                </div>
                <h1 class="display-6 fw-bold mb-2 text-white text-start">
                    إعدادات جوجل أناليتكس Google Analytics للتوريد 📈
                </h1>
                <p class="text-white-50 mb-0 leading-relaxed fs-6">
                    تتبع حركة الزوار وتحليل سلوك المستخدمين على موقع التوريد الخاص بك لفهم أداء المحتوى وتحسين التجربة الرقمية.
                </p>
            </div>
            <div class="col-lg-4 text-lg-end">
                <div class="d-flex flex-wrap gap-2 justify-content-lg-end">
                    ...
                    <button
                        ...
                        data-bs-toggle="modal" data-bs-target="#addanalyticsModal"
                        @if ($plan_id == 1 || ($plan_id == 2 && $apps_count >= 1) || ($plan_id == 3 && $apps_count >= 2)) disabled @endif>
        ...
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white hover-lift transition-all">
                <div class="card-body p-3.5">
                    ...
                    <h3 class="fw-bold mb-1 text-dark fs-4">{{ $analytics->count() }}</h3>
                    <p class="text-muted small mb-0 fw-semibold">إجمالي الحسابات المضافة</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white hover-lift transition-all">
                <div class="card-body p-3.5">
                    ...
                    <h3 class="fw-bold mb-1 text-dark fs-4">{{ $analytics->where('status', 'active')->count() }}</h3>
                    <p class="text-muted small mb-0 fw-semibold">حسابات أناليتكس المفعلة</p>
                </div>
            </div>
        </div>

        <!-- 3. Inactive Analytics -->
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white hover-lift transition-all">
                <div class="card-body p-3.5">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                    ...
                    <h3 class="fw-bold mb-1 text-dark fs-4">{{ $analytics->where('status', '!=', 'active')->count() }}</h3>
                    <p class="text-muted small mb-0 fw-semibold">حسابات أناليتكس المعطلة</p>
                </div>
            </div>
        </div>
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4 bg-white">
        <div
            ...
            <div class="d-flex flex-wrap align-items-center gap-2">
                <span class="avatar avatar-md rounded-3 bg-navy-subtle text-navy fw-bold me-1"
                    ...
                    <i class="fab fa-google fs-6"></i>
                </span>
                <h5 class="fw-bold mb-0 text-dark fs-6">قائمة إعدادات Google Analytics للتوريد</h5>
            </div>
            <button
        ...
        <div class="card-body p-0 p-md-3">
            <div class="table-responsive google-analytics-table-responsive custom-table-scroll">
                <table class="table table-hover align-middle mb-0 google-analytics-table">
                    <thead class="bg-light-subtle text-secondary small text-uppercase fw-bold border-bottom">
                        <tr>
                            ...
                            <th class="text-nowrap">معرف التتبع (Tracking ID)</th>
                    ...
                    <tbody>
                        @foreach ($analytics as $index => $analitic)
                            <tr id="row-{{ $analitic->id }}">
                                ...
                                <td data-label="معرف التتبع (Tracking ID)">
                                    <div class="d-flex align-items-center gap-2">
                                        <span class="avatar avatar-xs rounded-circle bg-navy-subtle text-navy fw-bold me-1"
                                        ...
                                        <span class="fw-bold text-dark font-monospace fs-6">
                                            {{ json_decode($analitic->data)->tracking_id }}
                                        </span>
                                    </div>
                                </td>
                                <td data-label="الحالة" class="text-center">
                                    <span
                                        class="badge {{ $analitic->status === 'active' ? 'bg-success-subtle text-success border border-success' : 'bg-secondary-subtle text-secondary border border-secondary' }} rounded-pill px-3 py-1.5 fw-semibold">
...
<div class="modal fade" id="addanalyticsModal" tabindex="-1" aria-labelledby="addanalyticsModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            <div class="modal-header text-white py-3.5 px-4"
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <h5 class="modal-title fw-bold mb-0 fs-6 text-white" id="addanalyticsModalLabel">إضافة إعدادات Google Analytics</h5>
                </div>
            ...
            <div class="modal-body p-4 bg-white">
                <form id="AddGoogleAnalyticsForm">
                    ...
                    <div class="mb-3.5">
                        <label class="form-label fw-bold text-dark small">معرف التتبع (Tracking ID) <span
                        ...
                        <div class="invalid-feedback d-block mt-1 small" id="error-tracking_id"></div>
                    </div>

                    <div class="p-3 bg-light rounded-3 border mb-4">
                        <div class="form-check form-switch d-flex align-items-center justify-content-between p-0 mb-0">
                            <label class="form-check-label fw-bold text-dark small mb-0" for="status">تفعيل التتبع تلقائيًا</label>
...
<div class="modal fade" id="editanalyticsModal" tabindex="-1" aria-labelledby="editanalyticsModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            <div class="modal-header text-white py-3.5 px-4"
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <h5 class="modal-title fw-bold mb-0 fs-6 text-white" id="editanalyticsModalLabel">تعديل إعدادات Google Analytics</h5>
                </div>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                    aria-label="إغلاق"></button>
            </div>
                ...
                <form id="EditGoogleAnalyticsForm">
                    ...
                    <div class="mb-3.5">
                        ...
                        <div class="input-group">
                            <span class="input-group-text bg-light border-end-0 rounded-start-3 text-muted"><i
                                    class="fab fa-google"></i></span>
                            <input type="text" name="tracking_id" id="edit_tracking_id"
                                class="form-control rounded-end-3 shadow-none border-start-0"
                    ...
                    <div class="p-3 bg-light rounded-3 border mb-4">
                        <div class="form-check form-switch d-flex align-items-center justify-content-between p-0 mb-0">
                            <label class="form-check-label fw-bold text-dark small mb-0" for="edit_status">تفعيل التتبع</label>
                            <input class="form-check-input ms-0 shadow-none" type="checkbox" name="status"
...
<style>
    ...
    @media (max-width: 1024.98px) {
        ...
        .google-analytics-table-responsive table.google-analytics-table,
        .google-analytics-table-responsive table.google-analytics-table tbody,
        .google-analytics-table-responsive table.google-analytics-table tr,
        .google-analytics-table-responsive table.google-analytics-table td,
        .google-analytics-table-responsive table.google-analytics-table th {
            display: block !important;
            width: 100% !important;
            box-sizing: border-box !important;
        }

        .google-analytics-table-responsive table.google-analytics-table thead {
            display: none !important;
        }

        .google-analytics-table-responsive table.google-analytics-table tbody tr {
        ...
        .google-analytics-table-responsive table.google-analytics-table tbody tr:hover {
            box-shadow: 0 8px 20px rgba(0, 0, 0, 0.08) !important;
        }

        .google-analytics-table-responsive table.google-analytics-table tbody td,
        .google-analytics-table-responsive table.google-analytics-table tbody th {
        ...
        .google-analytics-table-responsive table.google-analytics-table tbody td:last-child {
            border-bottom: none !important;
        }

        .google-analytics-table-responsive table.google-analytics-table tbody td::before,
        .google-analytics-table-responsive table.google-analytics-table tbody th::before {
    ...
    @media (min-width: 768px) and (max-width: 1024.98px) {
        ...
        .google-analytics-table-responsive table.google-analytics-table tbody th[data-label="#"] {
            grid-column: 1 / -1;
            border-bottom: 1px solid #e2e8f0 !important;
            padding-bottom: 0.5rem !important;
        }

        .google-analytics-table-responsive table.google-analytics-table tbody td[data-label="الإجراء"] {
            grid-column: 1 / -1;
            border-bottom: none !important;
