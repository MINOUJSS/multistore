<div class="container-fluid py-3 px-3 px-md-4">
        ...
        <div class="row align-items-center position-relative z-1">
            <div class="col-lg-8 mb-3 mb-lg-0">
                <div
                    ...
                    <span class="fw-semibold">{{ __('تحليل الجلسات وخرائط التفاعل للتوريد') }}</span>
                    <span class="opacity-50">|</span>
                    <span class="opacity-90">{{ now()->locale('ar')->translatedFormat('l، j F Y') }}</span>
                </div>
                <h1 class="display-6 fw-bold mb-2 text-white text-start">
                    إعدادات مايكروسوفت كلاريتي Microsoft Clarity للتوريد 📊
                </h1>
                <p class="text-white-50 mb-0 leading-relaxed fs-6">
                    فعّل Microsoft Clarity لتحليل سلوك الزوار عبر تسجيلات الجلسات وخرائط التفاعل لزيادة تحويلات متجر التوريد.
                </p>
            </div>
    ...
    <div class="row g-3 mb-4">
        <!-- 1. Total Configured Clarity Projects -->
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white hover-lift transition-all">
                <div class="card-body p-3.5">
                    ...
                    <h3 class="fw-bold mb-1 text-dark fs-4">{{ $clarities->count() }}</h3>
                    <p class="text-muted small mb-0 fw-semibold">إجمالي الإعدادات المضافة</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white hover-lift transition-all">
                <div class="card-body p-3.5">
                    ...
                    <h3 class="fw-bold mb-1 text-dark fs-4">{{ $clarities->where('status', 'active')->count() }}</h3>
                    <p class="text-muted small mb-0 fw-semibold">حسابات Clarity المفعلة</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white hover-lift transition-all">
                <div class="card-body p-3.5">
                    ...
                    <h3 class="fw-bold mb-1 text-dark fs-4">{{ $clarities->where('status', '!=', 'active')->count() }}</h3>
                    <p class="text-muted small mb-0 fw-semibold">حسابات Clarity المعطلة</p>
                </div>
            </div>
        </div>
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4 bg-white">
        <div
            ...
            <div class="d-flex flex-wrap align-items-center gap-2">
                ...
                <h5 class="fw-bold mb-0 text-dark fs-6">قائمة إعدادات Microsoft Clarity للتوريد</h5>
            </div>
            <button
        ...
        <div class="card-body p-0 p-md-3">
            <div class="table-responsive clarity-table-responsive custom-table-scroll">
                <table class="table table-hover align-middle mb-0 clarity-table">
                    <thead class="bg-light-subtle text-secondary small text-uppercase fw-bold border-bottom">
                        <tr>
                            ...
                            <th class="text-nowrap">معرف Clarity</th>
                                ...
                                <td data-label="معرف Clarity">
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <span class="fw-bold text-dark font-monospace fs-6">
                                            {{ json_decode($clarity->data)->clarity_id }}
                                        </span>
                                    </div>
                                </td>
                                <td data-label="الحالة" class="text-center">
                                    <span
                                        class="badge {{ $clarity->status === 'active' ? 'bg-success-subtle text-success border border-success' : 'bg-secondary-subtle text-secondary border border-secondary' }} rounded-pill px-3 py-1.5 fw-semibold">
        ...
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            <div class="modal-header text-white py-3.5 px-4"
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <h5 class="modal-title fw-bold mb-0 fs-6 text-white" id="addClarityModalLabel">إضافة إعدادات Microsoft Clarity</h5>
                </div>
            ...
            <div class="modal-body p-4 bg-white">
                <form id="AddClarityForm">
                    ...
                    <div class="mb-3.5">
                        <label class="form-label fw-bold text-dark small">معرف Clarity <span
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="clarity_id" id="clarity_id"
                                class="form-control rounded-end-3 shadow-none border-start-0"
                                placeholder="مثال: XXXXXXXXX">
                        </div>
                        <div class="invalid-feedback d-block mt-1 small" id="error-clarity_id"></div>
                    </div>

                    <div class="p-3 bg-light rounded-3 border mb-4">
                        <div class="form-check form-switch d-flex align-items-center justify-content-between p-0 mb-0">
                            <label class="form-check-label fw-bold text-dark small mb-0" for="status">تفعيل Clarity تلقائيًا</label>
...
<div class="modal fade" id="editClarityModal" tabindex="-1" aria-labelledby="editClarityModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            <div class="modal-header text-white py-3.5 px-4"
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <h5 class="modal-title fw-bold mb-0 fs-6 text-white" id="editClarityModalLabel">تعديل إعدادات Microsoft Clarity</h5>
                </div>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                    aria-label="إغلاق"></button>
            </div>
                ...
                <form id="EditClarityForm">
                    ...
                    <div class="mb-3.5">
                        ...
                        <div class="input-group">
                            <span class="input-group-text bg-light border-end-0 rounded-start-3 text-muted"><i
                                    class="fa-solid fa-chart-simple"></i></span>
                            <input type="text" name="clarity_id" id="edit_clarity_id"
                                class="form-control rounded-end-3 shadow-none border-start-0"
                                placeholder="XXXXXXXXX">
                        </div>
                        <div class="invalid-feedback d-block mt-1 small" id="error-edit-clarity_id"></div>
                    </div>

                    <div class="p-3 bg-light rounded-3 border mb-4">
                        <div class="form-check form-switch d-flex align-items-center justify-content-between p-0 mb-0">
                            <label class="form-check-label fw-bold text-dark small mb-0" for="edit_status">تفعيل Clarity</label>
                            <input class="form-check-input ms-0 shadow-none" type="checkbox" name="status"
...
<style>
    ...
    @media (max-width: 1024.98px) {
        ...
        .clarity-table-responsive table.clarity-table,
        .clarity-table-responsive table.clarity-table tbody,
        .clarity-table-responsive table.clarity-table tr,
        .clarity-table-responsive table.clarity-table td,
        .clarity-table-responsive table.clarity-table th {
            display: block !important;
            width: 100% !important;
            box-sizing: border-box !important;
        }

        .clarity-table-responsive table.clarity-table thead {
            display: none !important;
        }

        .clarity-table-responsive table.clarity-table tbody tr {
        ...
        .clarity-table-responsive table.clarity-table tbody tr:hover {
            box-shadow: 0 8px 20px rgba(0, 0, 0, 0.08) !important;
        }

        .clarity-table-responsive table.clarity-table tbody td,
        .clarity-table-responsive table.clarity-table tbody th {
        ...
        .clarity-table-responsive table.clarity-table tbody td:last-child {
            border-bottom: none !important;
        }

        .clarity-table-responsive table.clarity-table tbody td::before,
        .clarity-table-responsive table.clarity-table tbody th::before {
    ...
    @media (min-width: 768px) and (max-width: 1024.98px) {
        ...
        .clarity-table-responsive table.clarity-table tbody th[data-label="#"] {
            grid-column: 1 / -1;
            border-bottom: 1px solid #e2e8f0 !important;
            padding-bottom: 0.5rem !important;
        }

        .clarity-table-responsive table.clarity-table tbody td[data-label="الإجراء"] {
            grid-column: 1 / -1;
            border-bottom: none !important;
