        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{-- route('supplier.payment_proofs.refused.index') --}}" method="GET"> {{-- Assuming a route for filtering --}}
                        <div class="row g-2">
                            <div class="col-md-4">
                            ...
                            <tbody>
                                @forelse ($proofs as $proof)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('supplier.payments_proofs_refused.show', $proof->id) }}" class="btn btn-sm btn-info">عرض التفاصيل</a>
