<!-- Start Sid Bar  -->
<style>
    /* Modernized Supplier Sidebar CSS */
    .app-sidebar,
    .offcanvas-body {
        background: #a40c72 !important;
        /* Preserved primary color */
...
<div class="app-sidebar">
    <div class="logo-box text-center">
        <div class="logo-avatar-wrapper mb-2">
            <img class="logo-image" src="{{ asset('asset/v1/users/dashboard') }}/img/logo/store.png" alt="Supplier Logo"
                width="56" height="56">
            @if (get_supplier_data(Auth::user()->tenant_id)->approval_status == 'approved')
                <span class="verified-badge" title="مورد موثق">
        ...
        <div class="user-name">
            <span class="user-tenant-badge">
                <i class="fa-solid fa-truck-ramp-box me-1 small"></i> {{ Auth::user()->tenant_id }}
            </span>
        </div>
    </div>
...
<div class="offcanvas offcanvas-start d-lg-block d-lg-none d-xl-block d-xl-none d-xxl-block d-xxl-none"
    ...
    <div class="offcanvas-body pt-0">
        <div class="logo-box text-center">
            <div class="logo-avatar-wrapper mb-2">
                <img class="logo-image" src="{{ asset('asset/v1/users/dashboard') }}/img/logo/store.png"
                    alt="Supplier Logo" width="56" height="56">
                @if (get_supplier_data(Auth::user()->tenant_id)->approval_status == 'approved')
                    <span class="verified-badge" title="مورد موثق">
                        <i class="bi bi-check-lg"></i>
                    </span>
