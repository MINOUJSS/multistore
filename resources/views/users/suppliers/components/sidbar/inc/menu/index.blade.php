<div class="menu">
    ...
    <div class="sub-menu">
        <a class="sub-item" href="{{route('supplier.coupons')}}"><i class="fa-solid fa-ticket"></i> الكوبونات</a>
        <a class="sub-item" href="{{route('supplier.products-coupons')}}"><i class="fa-solid fa-diagram-project"></i> ربط الكوبونات بالمنتجات</a>
        <a class="sub-item" href="{{route('supplier.categories-coupons')}}"><i class="fa-solid fa-diagram-project"></i> ربط الكوبونات بالأقسام</a>
    </div>
    </div>
    ...
    <div class="item"><a href="{{route('supplier.payments_proofs_refuseds')}}"><i class="fa-solid fa-file-invoice-dollar"></i> إثباتات الدفع المرفوضة</a></div>
