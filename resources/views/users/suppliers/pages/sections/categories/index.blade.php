...
@section('content')
{{-- Your Content Here   --}}
  @include('users.suppliers.components.content.pages.sections.categories.index')
@endsection

@section('footer_js')
    @include('users.suppliers.components.content.pages.sections.categories.js.index_js')
@endsection