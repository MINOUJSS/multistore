...
@section('content')
    {{-- Your Content Here   --}}
    @include('users.suppliers.components.content.pages.sections.order_form.index')
@endsection

@section('footer_js')
    @include('users.suppliers.components.content.pages.sections.order_form.js.index_js')
    @include('users.suppliers.components.content.pages.sections.order_form.js.controller_js')
    @include('users.suppliers.components.content.pages.sections.order_form.js.submitform_js')
@endsection
