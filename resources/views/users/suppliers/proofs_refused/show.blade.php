...
@section('content')
{{-- Your Content Here   --}}
  @include('users.suppliers.components.content.proofs_refused.show')
@endsection
@section('footer_js')
@include('users.suppliers.components.content.proofs_refused.js.chat_box_js')
@endsection