...
@section('title')
    403 - الوصول محظور | لوحة تحكم المورد
@endsection
    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-6 text-center">
            <div class="card border-0 shadow-sm rounded-4 bg-white p-4 p-md-5 position-relative overflow-hidden">
                ...
                <h2 class="fw-bold text-dark mb-3 fs-3">وصول مقيّد أو غير مصرح به!</h2>
                
                <p class="text-muted mb-4 fs-6 leading-relaxed">
                    لا تملك الصلاحيات المطلوبة لعرض هذه الصفحة أو تنفيذ الإجراء داخل لوحة المورد.
                </p>
