<div class="container mt-4">
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('seller.categories-coupons') }}" class="btn btn-light btn-sm">رجوع</a>
        </div>
                ...
                <tbody>
                    @forelse($linkedCategories as $link)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('seller.categories-coupons.destroy', $link->id) }}" method="POST" onsubmit="return confirm('هل أنت متأكد من حذف هذا الربط؟');">
                                    @csrf
                                    @method('DELETE')
