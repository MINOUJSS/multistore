        ...
        <div class="row align-items-center position-relative z-1">
            <div class="col-lg-8 mb-3 mb-lg-0">
                <div
                    ...
                    <i class="fa-solid fa-ticket-alt text-warning"></i>
                    <span class="fw-semibold">{{ __('إدارة العروض والخصومات') }}</span>
                    <span class="opacity-50">|</span>
                    <span class="opacity-90">{{ now()->locale('ar')->translatedFormat('l، j F Y') }}</span>
                </div>
                <h1 class="display-6 fw-bold mb-2 text-white text-start">
                    إدارة وتتبع كوبونات الخصم 🎟️
                </h1>
                <p class="text-white-50 mb-0 leading-relaxed fs-6">
                    إضافة وتعديل وتنظيم كوبونات الخصم، متابعة نسب التخفيض وتواريخ الصلاحية وحالات الفاعلية بطريقة عصرية وذكية.
                </p>
            </div>
        ...
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white hover-lift transition-all">
                <div class="card-body p-3.5">
                    ...
                    <p class="text-muted small mb-0 fw-semibold">إجمالي الكوبونات</p>
                </div>
            </div>
        </div>
            ...
            <div class="row g-2 g-md-3">
                <div class="col-12 col-sm-6 col-md-3">
                    <label class="form-label fw-semibold text-secondary small">
                        <i class="fa-solid fa-tags me-1 text-plum"></i> نوع الكوبون
                    </label>
                ...
                <div class="col-12 col-md-2 d-flex align-items-end mt-2 mt-md-0">
                    <button id="searchBtn" class="btn btn-seller-primary w-100 rounded-3 fw-bold shadow-sm d-flex align-items-center justify-content-center gap-2 py-2">
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4 bg-white">
        <div class="card-header bg-white border-0 py-3.5 px-3 px-md-4 d-flex flex-wrap align-items-center justify-content-between gap-2 border-bottom border-light">
            <div class="d-flex flex-wrap align-items-center gap-2">
                ...
                <h5 class="fw-bold mb-0 text-dark fs-6">قائمة كوبونات الخصم</h5>
            </div>
            <span class="badge bg-light text-dark border px-3 py-1.5 rounded-pill small fw-semibold">
                <i class="fa-solid fa-layer-group me-1 text-plum"></i> إجمالي المعروض: {{ method_exists($coupons, 'count') ? $coupons->count() : count($coupons) }} كوبون
            </span>
        </div>
                        ...
                        @foreach ($coupons as $coupon)
                            <tr>
                                ...
                                <td data-label="القيمة">
                                    <span class="fw-bold text-plum fs-6">
                                        @if ($coupon->type == 'percent')
                                            {{ $coupon->value }}%
                                        @else
                                ...
                                <td data-label="الإجراءات" class="pe-md-4 text-end">
                                    <button value="{{ $coupon->id }}" class="btn btn-sm btn-outline-plum rounded-3 edit-coupon px-2.5 py-1 me-1 shadow-2xs fw-semibold" data-bs-toggle="modal" data-bs-target="#editCouponModal">
...
<div class="modal fade" id="addCouponModal" tabindex="-1" aria-labelledby="addCouponModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            <div class="modal-header bg-seller-header py-3 px-4">
                ...
                <form id="addCouponForm" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control rounded-start-3 shadow-none text-uppercase fw-bold font-monospace" id="add_code" name="code" placeholder="مثال: SUMMER2026" required>
                            <button class="btn btn-seller-primary px-3 fw-bold rounded-end-3" type="button" id="generateCode">
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-text rounded-end-3 bg-light fw-bold text-plum" id="valueSuffix">%</span>
                            </div>
            ...
            <div class="modal-footer bg-light border-0 py-3 px-4">
                ...
                <button type="button" class="btn btn-seller-primary rounded-3 px-4 fw-bold shadow-sm" id="saveCoupon">
...
<div class="modal fade" id="editCouponModal" tabindex="-1" aria-labelledby="editCouponModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            ...
            <div class="modal-body p-4">
                <form id="editCouponForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control rounded-3 shadow-none bg-light font-monospace fw-bold text-plum" id="edit_code" name="code" readonly>
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-text rounded-end-3 bg-light fw-bold text-plum" id="editValueSuffix">%</span>
                            </div>
            ...
            <div class="modal-footer bg-light border-0 py-3 px-4">
                <button type="button" class="btn btn-light rounded-3 px-4 fw-semibold" data-bs-dismiss="modal">إلغاء</button>
                <button type="button" class="btn btn-seller-primary rounded-3 px-4 fw-bold shadow-sm" id="updateCoupon">
