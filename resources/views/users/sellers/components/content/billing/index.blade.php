        ...
        <div class="row align-items-center position-relative z-1">
            <div class="col-lg-7 mb-3 mb-lg-0">
                <div
                    ...
                    <span class="fw-semibold">{{ __('إدارة الفواتير والمدفوعات الإلكترونية') }}</span>
                ...
                <p class="text-white-50 mb-0 leading-relaxed fs-6">
                    استعرض جميع الفواتير الصادرة، تتبع حالة السداد، وقم بتحرير فواتير جديدة بسهولة لتنظيم أعمال متجرك.
                </p>
            </div>
            <div class="col-lg-5 text-lg-end">
                <a href="{{ route('seller.billing.invoice.create') }}"
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white hover-lift transition-all">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <span class="badge bg-plum-subtle text-plum rounded-pill px-3 py-1 fw-bold">إجمالي الفواتير</span>
                    </div>
                    <h2 class="fw-bold mb-1 text-dark">{{ $invoices->count() }} <span class="fs-6 text-muted">فاتورة</span></h2>
                    <p class="text-muted small mb-0 fw-semibold">مجموع الفواتير الصادرة للمتجر</p>
                </div>
            </div>
        </div>
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4 bg-white">
        <div class="card-header bg-white border-0 py-3.5 px-3 px-md-4 d-flex flex-wrap align-items-center justify-content-between gap-2 border-bottom border-light">
            <div class="d-flex flex-wrap align-items-center gap-2">
                ...
                <h5 class="fw-bold mb-0 text-dark fs-6">سجل الفواتير الصادرة</h5>
            </div>
            <a href="{{ route('seller.billing.invoice.create') }}"
                class="btn btn-seller-primary rounded-3 px-3.5 py-2 fs-6 fw-bold shadow-sm d-inline-flex align-items-center gap-2">
                <i class="fa-solid fa-plus-circle"></i>
                <span>تحرير فاتورة جديدة</span>
            </a>
        </div>
                            ...
                            <tr>
                                ...
                                <td data-label="طريقة الدفع">
                                    <span class="badge bg-light text-dark border px-2.5 py-1.5 fw-semibold">
                                        <i class="fa-solid fa-credit-card me-1 text-plum"></i> {{ $invoice->payment_method }}
                                    </span>
                                </td>
                                ...
                                <td data-label="الإجراء" class="text-center pe-md-4">
                                    <div class="d-inline-flex flex-wrap align-items-center justify-content-center gap-1.5">
                                        ...
                                        @if($invoice->payment_proof && $invoice->status != 'paid')
                                            <form action="{{ route('seller.billing.invoice.deleteProof', $invoice->id) }}" method="POST"
        ...
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            ...
            <div class="modal-body p-4 bg-white text-center">
                ...
                <button class="btn btn-outline-plum w-100 py-3 mb-3 rounded-3 fw-bold d-flex align-items-center justify-content-between px-3"
                    ...
                    <div class="d-flex align-items-center gap-2">
                        <i class="fa-solid fa-mobile-screen-button fs-5 text-plum"></i>
