            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body d-flex flex-wrap gap-2 justify-content-center justify-content-md-start">
                        <a href="{{route('seller.billing.invoice.create')}}" class="btn btn-primary">
                    ...
                    @foreach ($invoices as $index => $invoice)
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('seller.billing.invoice.deleteProof', $invoice->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('هل أنت متأكد من حذف إثبات الدفع؟');">
                                    @csrf
                                    @method('DELETE')
