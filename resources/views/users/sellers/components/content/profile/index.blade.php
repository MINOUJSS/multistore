        ...
        <div class="col-lg-3 mb-4">
            <div class="profile-sidebar bg-white rounded-4 shadow-sm p-4 sticky-top" style="top: 20px;">
                <div class="text-center">
                    ...
                    <!-- معلومات المستخدم -->
                    <h4 class="fw-bold mb-1">{{ $seller->full_name }}</h4>
                ...
                <div class="p-4">
                    ...
                    <div class="tab-content" id="profile-tabContent">
                            ...
                            <form action="{{ route('seller.profile.update') }}" method="POST" class="row g-4"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-select" name="sex" id="sex">
                                            ...
                                            <option value="male" {{ $seller->sex == 'male' ? 'selected' : '' }}>
                                                ذكر
                                            </option>
                                            <option value="female" {{ $seller->sex == 'female' ? 'selected' : '' }}>
                                                انثى</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text bg-light"><i
                                                class="fas fa-map-marked-alt"></i></span>
                                        <textarea name="address" class="form-control" rows="3" placeholder="العنوان...">{{ $seller->address }}</textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                ...
                                @if ($seller->id_card_image != null)
                                    <div class="col-12 text-center">
                                        <img src="{{ $seller->id_card_image }}" alt="وثيقة الهوية" width="300px">
                                    </div>
                                @endif
                                <div class="col-12">
                        ...
                        <div class="tab-pane fade" id="chargily" role="tabpanel">
                            ...
                            <form action="{{ route('seller.profile.chargily-settings.update') }}" method="POST"
                                class="row g-4">
                                @csrf
                                {{-- <div class="col-12">
                                    <div class="alert alert-info border-0 bg-light-info">
                            ...
                            @if ($chargily_settings != null)
                                <form action="{{ route('seller.profile.chargily-settings.delete') }}"
                                    method="POST">
                                    @csrf
                                    @method('DELETE')
                        ...
                        <div class="tab-pane fade" id="bank" role="tabpanel">
                            ...
                            <form action="{{ route('seller.profile.bank-settings.update') }}" method="POST"
                                class="row g-4">
                                @csrf
                                {{-- <div class="col-12">
                                    <div class="alert alert-info border-0 bg-light-info">
                            ...
                            @if ($bank_settings != null)
                                <form action="{{ route('seller.profile.bank-settings.delete') }}"
                                method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-danger px-4 py-2 fw-medium w-100 mt-3"><i
