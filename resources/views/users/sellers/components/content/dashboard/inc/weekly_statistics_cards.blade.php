            ...
            <div class="col-sm-12 col-md-6 col-lg-3">
                <div class="card bg-white text-white h-100 border-primary">
                    <div class="card-body">
                        ...
                        <h2 class="card-text mb-2 text-primary">{{ $seller->ordersThisWeek->count() }}</h2>
            ...
            <div class="col-sm-12 col-md-6 col-lg-3">
                <div class="card bg-white text-success h-100 border-success">
                    <div class="card-body">
                        ...
                        <h2 class="card-text mb-2">{{ $seller->ordersConfirmedThisWeek->count() }}</h2>
                        <div class="d-flex align-items-center">
            ...
            <div class="col-sm-12 col-md-6 col-lg-3">
                <div class="card bg-white text-danger h-100 border-danger">
                    <div class="card-body">
                        ...
                        <h2 class="card-text mb-2">{{ $seller->ordersCanceledThisWeek->count() }}</h2>
                        <div class="d-flex align-items-center">
            ...
            <div class="col-sm-12 col-md-6 col-lg-3">
                <div class="card bg-white text-primary h-100 border-primary">
                    <div class="card-body">
                        ...
                        <h2 class="card-text mb-2">{{ $seller->ordersdeliveredThisWeek->count() }}</h2>
                        <div class="d-flex align-items-center">
