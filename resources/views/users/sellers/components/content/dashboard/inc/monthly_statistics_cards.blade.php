    ...
    <div class="col-sm-12 col-md-6 col-lg-3">
        <div class="card border-0 shadow-sm rounded-4 h-100 bg-white dashboard-stat-card">
            <div class="card-body p-3">
                ...
                <h3 class="fw-bold mb-2 text-dark">{{ $seller->ordersThisMonth->count() }}</h3>
    ...
    <div class="col-sm-12 col-md-6 col-lg-3">
        <div class="card border-0 shadow-sm rounded-4 h-100 bg-white dashboard-stat-card">
            <div class="card-body p-3">
                ...
                <h3 class="fw-bold mb-2 text-dark">{{ $seller->ordersConfirmedThisMonth->count() }}</h3>
                <div class="d-flex align-items-center gap-1 small">
    ...
    <div class="col-sm-12 col-md-6 col-lg-3">
        <div class="card border-0 shadow-sm rounded-4 h-100 bg-white dashboard-stat-card">
            <div class="card-body p-3">
                ...
                <h3 class="fw-bold mb-2 text-dark">{{ $seller->ordersCanceledThisMonth->count() }}</h3>
                <div class="d-flex align-items-center gap-1 small">
    ...
    <div class="col-sm-12 col-md-6 col-lg-3">
        <div class="card border-0 shadow-sm rounded-4 h-100 bg-white dashboard-stat-card">
            <div class="card-body p-3">
                ...
                <h3 class="fw-bold mb-2 text-dark">{{ $seller->ordersDeliveredThisMonth->count() }}</h3>
                <div class="d-flex align-items-center gap-1 small">
                    @if ($isDeliveredIncrease)
                        <span class="badge bg-emerald-subtle text-emerald border-0 rounded-pill"><i class="fa-solid fa-arrow-up me-1"></i>{{ $percentageDeliveredChange }}%</span>
                    @else
