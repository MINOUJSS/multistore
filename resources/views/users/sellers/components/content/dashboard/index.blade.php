...
<div class="container-fluid px-3 py-2">
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4 overflow-hidden"
        style="background: linear-gradient(135deg, #ffffff 0%, #fcf7fa 100%); border-right: 5px solid #a40c72 !important;">
        <div class="card-header bg-white border-0 py-3.5 px-4 d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center gap-3">
                <div class="stat-icon-wrapper bg-opacity-10 text-white"
                    style="background-color: #a40c72; width: 44px; height: 44px; border-radius: 12px; display: flex; align-items: center; justify-content: center;">
                    <i class="fa-solid fa-headset fs-5"></i>
                </div>
                <div>
                    <h5 class="fw-bold mb-1 text-dark">مركز الكول سنتر والدعم الفني المباشر</h5>
                    <p class="text-muted small mb-0">نحن هنا لمساعدتك في حل أي مشكلة، زيادة مبيعاتك، وضمان نجاح تجارتك
                        بكل أمان وموثوقية.</p>
                </div>
            </div>
            <div class="d-flex align-items-center gap-2">
                ...
                <button class="btn btn-sm btn-light border-0 shadow-sm rounded-circle p-2" type="button"
                    data-bs-toggle="collapse" data-bs-target="#sellerSupportPanel" aria-expanded="true">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div
                            ...
                            <div class="fw-bold text-dark fs-6 mb-3 dir-ltr" style="direction: ltr !important;">+213 672
                                81 67 09</div>
                            <a href="https://wa.me/213672816709?text=مرحباً%20فريق%20الدعم،%20أنا%20تاجر%20في%20منصة%20Dzora%20وأحتاج%20إلى%20مساعدة"
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="border border-light-subtle rounded-3 p-3 h-100 bg-white shadow-xs text-center position-relative transition-all hover-lift"
                            ...
                            <a href="https://t.me/+v0gwM7QgyC0xNWU0" target="_blank"
    ...
    @include('users.sellers.components.content.dashboard.inc.dayly_statistics_cards')
                ...
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            ...
                            <p class="text-muted small mb-0">مراقبة نمو الطلبات حسب الفترة الزمانية</p>
                        </div>
                        <select id="timeRange"
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white">
                <div class="card-body p-4">
                    <div class="mb-4">
                        ...
                        <p class="text-muted small mb-0 text-center">نسب الحالات المختلفة للطلبات</p>
                    </div>
                    <div style="position: relative; width: 100%; min-height: 260px;"
    ...
    @include('users.sellers.components.content.dashboard.inc.weekly_statistics_cards')
                ...
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            ...
                            <p class="text-muted small mb-0">متابعة إحصائيات وعدد زوار متجرك الإلكتروني</p>
                        </div>
    ...
    @include('users.sellers.components.content.dashboard.inc.monthly_statistics_cards')
