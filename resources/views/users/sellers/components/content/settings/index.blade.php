        ...
        <div class="row align-items-center position-relative z-1">
            <div class="col-lg-8 mb-3 mb-lg-0">
                <div
                    ...
                    <span class="fw-semibold">{{ __('مركز إعدادات المتجر والهوية البصرية') }}</span>
                    <span class="opacity-50">|</span>
                    <span class="opacity-90">{{ now()->locale('ar')->translatedFormat('l، j F Y') }}</span>
                </div>
                <h1 class="display-6 fw-bold mb-2 text-white text-start">
                    إعدادات المتجر والتصميم ⚙️
                </h1>
            ...
            <ul class="nav nav-pills gap-2" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link rounded-3 fw-bold px-3.5 py-2.5 {{ session('active_tab') == 'store_setting' ? '' : 'active' }}"
                        ...
                        <i class="fa-solid fa-palette me-1.5 text-plum"></i> الثيم والهوية
                    </button>
                </li>
        ...
        <div class="card-body p-4 p-md-5">
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade {{ session('active_tab') == 'store_setting' ? '' : 'show active' }}"
                    ...
                    <form action="{{ route('seller.theme-update', Auth::user()->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf

                        <!-- الشعار والهوية البصرية -->
                        <div class="card border rounded-4 p-4 mb-4 bg-light-subtle">
                            <h5 class="fw-bold text-dark mb-3 border-bottom pb-2">
                                <i class="fa-solid fa-image text-plum me-1"></i> شعار وهوية المتجر
                            </h5>
                        ...
                        <div class="card border rounded-4 p-4 mb-4 bg-light-subtle">
                            <h5 class="fw-bold text-dark mb-3 border-bottom pb-2">
                                <i class="fa-solid fa-swatchbook text-plum me-1"></i> ألوان الثيم وتنسيق النصوص
                            </h5>
                ...
                <div class="tab-pane fade {{ session('active_tab') == 'store_setting' ? 'show active' : '' }}"
                    ...
                    @include('users.sellers.components.content.settings.inc.setting_form')
                </div>
                            ...
                            <div class="col">
                                <div class="card h-100 border shadow-sm rounded-4 overflow-hidden transition-all hover-lift">
                                    <div class="card-body d-flex flex-column justify-content-between p-4">
                                        ...
                                        <button class="btn btn-outline-plum w-100 rounded-3 fw-bold mt-3" data-bs-toggle="modal"
                            ...
                            <div class="modal fade" id="editModal{{ $page['id'] }}" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <div class="modal-content rounded-4 border-0 shadow">
                                        <form method="POST" action="{{ route('seller.page.update', $page->id) }}">
                                            @csrf
                                            @method('PUT')

                                            <div class="modal-header bg-plum-subtle border-bottom">
                                                <h5 class="modal-title fw-bold text-plum" id="editModalLabel{{ $page->id }}">
                                            ...
                                            <div class="modal-footer bg-light-subtle border-top">
                                                <button type="submit" class="btn btn-seller-primary px-4 rounded-3 fw-bold"
                    ...
                    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
                        <div class="col">
                            <div class="card h-100 border shadow-sm rounded-4 overflow-hidden transition-all hover-lift">
                                <div class="card-body d-flex flex-column justify-content-between p-4">
                                    <div>
                                        <div class="d-inline-flex align-items-center justify-content-center p-3 rounded-3 bg-plum-subtle text-plum mb-3">
                                        ...
                                        <p class="card-text text-muted small leading-relaxed">
                                            إدارة صور البانرات الإعلانية المتحركة في الواجهة الرئيسية للمتجر.
                                        </p>
                                    </div>
                                    <a href="{{ route('seller.sliders.index') }}" class="btn btn-seller-primary w-100 rounded-3 fw-bold mt-3">
                                        <i class="fa-solid fa-pen-to-square me-1"></i> تعديل المحتوى
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="card h-100 border shadow-sm rounded-4 overflow-hidden transition-all hover-lift">
                                <div class="card-body d-flex flex-column justify-content-between p-4">
                                    <div>
                                        ...
                                        <p class="card-text text-muted small leading-relaxed">
                                            تنظيم وترتيب فئات وأقسام المنتجات المعروضة للزبائن.
                                        </p>
                                    </div>
                                    <a href="{{ route('seller.categories.index') }}" class="btn btn-seller-primary w-100 rounded-3 fw-bold mt-3">
                                        <i class="fa-solid fa-pen-to-square me-1"></i> تعديل المحتوى
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col">
                            <div class="card h-100 border shadow-sm rounded-4 overflow-hidden transition-all hover-lift">
                                <div class="card-body d-flex flex-column justify-content-between p-4">
                                    ...
                                    <a href="{{ route('seller.benefits.element.index') }}" class="btn btn-seller-primary w-100 rounded-3 fw-bold mt-3">
                                        <i class="fa-solid fa-pen-to-square me-1"></i> تعديل المحتوى
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col">
                            <div class="card h-100 border shadow-sm rounded-4 overflow-hidden transition-all hover-lift">
                                <div class="card-body d-flex flex-column justify-content-between p-4">
                                    ...
                                    <a href="{{ route('seller.faqs.index') }}" class="btn btn-seller-primary w-100 rounded-3 fw-bold mt-3">
                                        <i class="fa-solid fa-pen-to-square me-1"></i> تعديل المحتوى
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col">
                            <div class="card h-100 border shadow-sm rounded-4 overflow-hidden transition-all hover-lift">
                                <div class="card-body d-flex flex-column justify-content-between p-4">
                                    ...
                                    <a href="{{ route('seller.order-form.index') }}" class="btn btn-seller-primary w-100 rounded-3 fw-bold mt-3">
                                        <i class="fa-solid fa-pen-to-square me-1"></i> تعديل المحتوى
                                    </a>
                                </div>
                            </div>
