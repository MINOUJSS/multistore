    ...
    <div class="card">
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show {{ session('active_tab') == 'store_setting' ? '' : 'show active' }}"
                ...
                <form action="{{ route('seller.theme-update', Auth::user()->id) }}" method="POST"
                    ...
                    <div class="col mb-4">
                        <div class="card h-100 shadow-sm">
                            <div class="card-body d-flex flex-column justify-content-between">
                                ...
                                <a href="{{ route('seller.sliders.index') }}" class="btn btn-primary mt-3">تعديل
                                    المحتوى</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col mb-4">
                        <div class="card h-100 shadow-sm">
                            <div class="card-body d-flex flex-column justify-content-between">
                                ...
                                <a href="{{ route('seller.categories.index') }}" class="btn btn-primary mt-3">تعديل
                                    المحتوى</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col mb-4">
                        <div class="card h-100 shadow-sm">
                            <div class="card-body d-flex flex-column justify-content-between">
                                ...
                                <a href="{{ route('seller.benefits.element.index') }}"
                    ...
                    <div class="col mb-4">
                        <div class="card h-100 shadow-sm">
                            <div class="card-body d-flex flex-column justify-content-between">
                                ...
                                <a href="{{ route('seller.faqs.index') }}" class="btn btn-primary mt-3">تعديل
                                    المحتوى</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card h-100 shadow-sm">
                            <div class="card-body d-flex flex-column justify-content-between">
                                ...
                                <a href="{{ route('seller.order-form.index') }}" class="btn btn-primary mt-3">تعديل
                                    المحتوى</a>
                            </div>
                        </div>
                    </div>
