        ...
        <div class="row align-items-center position-relative z-1">
            <div class="col-lg-8 mb-3 mb-lg-0">
                <div
                    ...
                    <span class="fw-semibold">{{ __('تأكيد الاشتراك والدفع النهائي') }}</span>
                ...
                <p class="text-white-50 mb-0 leading-relaxed fs-6">
                    راجع تفاصيل الخطة المحددة ومعادلة التكلفة الصافية، ثم اختر طريقة الدفع المناسبة لإكمال عملية الترقية بنجاح.
                </p>
            </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden bg-white mb-4">
                <div class="card-header bg-white border-0 py-3.5 px-4 border-bottom border-light">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <h5 class="fw-bold mb-0 text-dark fs-6">تفاصيل طلب ترقية الباقة</h5>
                    </div>
                </div>

                <div class="card-body p-4 p-md-5">
                    @php
                        $planData = get_seller_plan_data($order->plan_id);
                    @endphp
                    ...
                    <div class="p-4 rounded-4 bg-light-subtle border mb-4">
                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-3">
                            <div>
                                <span class="badge bg-plum-subtle text-plum fw-bold px-3 py-1.5 rounded-pill mb-2">
                                    الخطة المختارة
                                </span>
                    ...
                    @if ($old_subscription->plan_id == 1 && in_array($order->plan_id, [2, 3]))
                        <div class="p-3.5 rounded-3 bg-plum-subtle border border-plum-subtle mb-4">
                            <h6 class="fw-bold text-plum mb-3"><i class="fa-solid fa-calculator me-1"></i> ملخص الاشتراك الجديد:</h6>
                            <div class="row g-2">
                                <div class="col-6">
                                ...
                                <div class="col-6">
                                    <div class="p-2.5 bg-white rounded-3 border">
                                        ...
                                        <span class="fw-bold text-plum fs-5">{{ $total }} د.ج</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    @elseif ($old_subscription->plan_id == 2 && $order->plan_id == 3)
                        <div class="p-3.5 rounded-3 bg-plum-subtle border border-plum-subtle mb-4">
                            <h6 class="fw-bold text-plum mb-3"><i class="fa-solid fa-calculator me-1"></i> ملخص تصفية الرصيد والاشتراك:</h6>
                            <div class="row g-2">
                                <div class="col-md-4">
                                    <div class="p-2.5 bg-white rounded-3 border">
                                ...
                                <div class="col-md-4">
                                    <div class="p-2.5 bg-white rounded-3 border">
                                        ...
                                        <span class="fw-bold text-plum fs-5">{{ $total < 0 ? 0 : $total }} د.ج</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- نموذج الدفع -->
                    <form action="{{ route('seller.subscription.paymethod.redirect') }}" method="POST">
                        @csrf
