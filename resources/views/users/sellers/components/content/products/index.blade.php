                            ...
                            <tr>
                                ...
                                <td data-label="التصنيف"><span
                                        class="badge bg-light text-dark border fw-semibold px-2.5 py-1.5 rounded-3"><i
                                            class="fa-solid fa-tag me-1 text-plum"></i>{{ get_seller_product_category($product->id) }}</span>
                                </td>
                        ...
                        <div class="col-md-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" name="free_shipping" id="edit_free_shipping"
                                    type="checkbox" checked>
                                <label class="form-check-label" for="edit_free_shipping">توصيل مجاني</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-check form-switch">
