...
$(document).ready(function() {
    ...
    $(document).on('click', '.edit-faq', function() {
        ...
        $.ajax({
            url: `/seller-panel/page/faqs/${faqId}/edit`,
            type: 'GET',
    ...
    $('#addFaqForm').submit(function(e) {
        e.preventDefault();
        submitForm($(this), 'POST', '/seller-panel/page/faqs');
    });

    $('#editFaqForm').submit(function(e) {
        e.preventDefault();
        const faqId = $('#edit_faq_id').val();
        submitForm($(this), 'PUT', `/seller-panel/page/faqs/${faqId}/update`);
    });
    ...
    $(document).on('click', '.delete-faq', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: `/seller-panel/page/faqs/${faqId}/delete`,
                    type: 'POST',
                    data: {
                        '_method': 'DELETE',
