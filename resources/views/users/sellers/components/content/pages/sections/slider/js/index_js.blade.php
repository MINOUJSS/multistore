...
$(document).ready(function() {
    ...
    $(document).on('click', '.edit-slider', function() {
        ...
        $.ajax({
            url: `/seller-panel/page/section/sliders/${sliderId}/edit`,
            type: 'GET',
    ...
    $('#addSliderForm').submit(function(e) {
        e.preventDefault();
        submitForm($(this), 'POST', '/seller-panel/page/section/sliders');
    });

    $('#editSliderForm').submit(function(e) {
        e.preventDefault();
        const sliderId = $('#edit_slider_id').val();
        submitForm($(this), 'POST', `/seller-panel/page/section/sliders/${sliderId}/update`, 'PUT');
    });
    ...
    $(document).on('click', '.delete-slider', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: `/seller-panel/page/section/sliders/${sliderId}/delete`,
                    type: 'POST',
                    data: {
                        '_method': 'DELETE',
