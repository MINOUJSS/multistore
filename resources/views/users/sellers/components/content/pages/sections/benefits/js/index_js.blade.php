...
$(document).ready(function() {
    ...
    $(document).on('click', '.edit-element', function() {
        ...
        $.ajax({
            url: `/seller-panel/page/section/benefits/elements/${elementId}/edit`,
            type: 'GET',
    ...
    $('#addElementForm').submit(function(e) {
        e.preventDefault();
        submitForm($(this), 'POST', '/seller-panel/page/section/benefits');
    });

    $('#editElementForm').submit(function(e) {
        e.preventDefault();
        const elementId = $('#edit_element_id').val();
        submitForm($(this), 'POST', `/seller-panel/page/section/benefits/elements/${elementId}/update`, 'PUT');
    });
    ...
    $(document).on('click', '.delete-element', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: `/seller-panel/page/section/benefits/elements/${elementId}/delete`,
                    type: 'POST',
                    data: {
                        '_method': 'DELETE',
