<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                    <form action="{{ route('seller.categories.updateStatus') }}" method="POST" class="row">
                        @csrf
...
@include('users.sellers.components.content.pages.sections.categories.inc.modals.global-category')

<!-- Modals for Store Categories -->
@include('users.sellers.components.content.pages.sections.categories.inc.modals.store-category')
