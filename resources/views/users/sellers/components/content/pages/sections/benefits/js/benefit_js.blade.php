...
$(document).ready(function() {
    ...
    $(document).on('click', '.edit-benefit', function() {
        ...
        // Fetch benefit data
        $.ajax({
            url: `/seller-panel/page/section/benefits/${benefitId}/edit`, // Update this URL to match your route
            type: 'GET',
    ...
    $('#editBenefitForm').submit(function(e) {
        ...
        $.ajax({
            url: `/seller-panel/page/section/benefits/${benefitId}/update`, // Update this URL to match your route
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
