        ...
        <div class="row align-items-center position-relative z-1">
            <div class="col-lg-8 mb-3 mb-lg-0">
                <div
                    ...
                    <span class="fw-semibold">{{ __('تحليل الجلسات وخرائط التفاعل') }}</span>
                    <span class="opacity-50">|</span>
                    <span class="opacity-90">{{ now()->locale('ar')->translatedFormat('l، j F Y') }}</span>
                </div>
                <h1 class="display-6 fw-bold mb-2 text-white text-start">
                    إعدادات مايكروسوفت كلاريتي Microsoft Clarity 📊
                </h1>
                <p class="text-white-50 mb-0 leading-relaxed fs-6">
                    فعّل Microsoft Clarity لتحليل سلوك الزوار عبر تسجيلات الجلسات وخرائط التفاعل لزيادة التحويلات.
                </p>
            </div>
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4 bg-white">
        <div
            ...
            <div class="d-flex flex-wrap align-items-center gap-2">
                ...
                <h5 class="fw-bold mb-0 text-dark fs-6">قائمة إعدادات Microsoft Clarity</h5>
            </div>
            <button
                            ...
                            <tr id="row-{{ $clarity->id }}">
                                ...
                                <td data-label="معرف Clarity">
                                    <div class="d-flex align-items-center gap-2">
                                        <span class="avatar avatar-xs rounded-circle bg-plum-subtle text-plum fw-bold me-1"
