        ...
        <div class="row align-items-center position-relative z-1">
            <div class="col-lg-8 mb-3 mb-lg-0">
                ...
                <h1 class="display-6 fw-bold mb-2 text-white text-start">
                    إعدادات بكسل فيسبوك Facebook Pixel 📘
                </h1>
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4 bg-white">
        <div
            ...
            <div class="d-flex flex-wrap align-items-center gap-2">
                ...
                <h5 class="fw-bold mb-0 text-dark fs-6">قائمة بكسلات فيسبوك Facebook Pixel</h5>
            </div>
            <button
                            ...
                            <tr id="row-{{ $pixel->id }}">
                                ...
                                <td data-label="معرف البكسل (Pixel ID)">
                                    <div class="d-flex align-items-center gap-2">
                                        <span class="avatar avatar-xs rounded-circle bg-primary text-white fw-bold me-1"
