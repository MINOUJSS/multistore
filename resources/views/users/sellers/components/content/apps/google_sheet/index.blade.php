        ...
        <div class="row align-items-center position-relative z-1">
            <div class="col-lg-8 mb-3 mb-lg-0">
                <div
                    ...
                    <span class="fw-semibold">{{ __('مزامنة الطلبات والبيانات التلقائية') }}</span>
                    <span class="opacity-50">|</span>
                    <span class="opacity-90">{{ now()->locale('ar')->translatedFormat('l، j F Y') }}</span>
                </div>
                <h1 class="display-6 fw-bold mb-2 text-white text-start">
                    إعدادات جوجل شيت Google Sheets 📊
                </h1>
                <p class="text-white-50 mb-0 leading-relaxed fs-6">
                    ربط متجرك بجداول بيانات Google Sheets لمزامنة الطلبات وتحديث بيانات المبيعات تلقائيًا وبسهولة.
                </p>
            </div>
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4 bg-white">
        <div
            ...
            <div class="d-flex flex-wrap align-items-center gap-2">
                ...
                <h5 class="fw-bold mb-0 text-dark fs-6">قائمة إعدادات Google Sheets</h5>
            </div>
            <button
                            ...
                            <tr id="row-{{ $sheet->id }}">
                                ...
                                <td data-label="معرف Google Sheet">
                                    <div class="d-flex align-items-center gap-2">
                                        <span class="avatar avatar-xs rounded-circle bg-success text-white fw-bold me-1"
