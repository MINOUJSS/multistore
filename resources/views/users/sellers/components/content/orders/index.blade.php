<div class="container-fluid py-3 px-3 px-md-4">
        ...
        <div class="row align-items-center position-relative z-1">
            <div class="col-lg-8 mb-3 mb-lg-0">
                <div class="d-inline-flex align-items-center gap-2 px-3 py-1 bg-white bg-opacity-10 rounded-pill text-white small mb-3 border border-white border-opacity-15 backdrop-blur">
                    ...
                    <span class="fw-semibold">{{ __('إدارة الطلبات') }}</span>
                    <span class="opacity-50">|</span>
                    <span class="opacity-90">{{ now()->locale('ar')->translatedFormat('l، j F Y') }}</span>
                </div>
                <h1 class="display-6 fw-bold mb-2 text-white text-start">
                    إدارة وتتبع طلبيات المتجر 📦
                </h1>
                <p class="text-white-50 mb-0 leading-relaxed fs-6">
                    متابعة وتأكيد طلبات العملاء، إدارة حالات الشحن والتوصيل، وإحصائيات المبيعات بطريقة عصرية وسريعة.
                </p>
            </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white dashboard-stat-card">
                <div class="card-body p-3">
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        ...
                        <span class="badge bg-plum-subtle text-plum px-2 py-1 rounded-pill fw-semibold small">الكل</span>
                    </div>
            ...
            <div class="row g-3">
                <div class="col-md-3">
                    <label class="form-label fw-semibold text-secondary small">
                        <i class="fa-solid fa-truck me-1 text-plum"></i> حالة الشحن
                    </label>
                ...
                <div class="col-md-3">
                    <label class="form-label fw-semibold text-secondary small">
                        <i class="fa-solid fa-calendar me-1 text-plum"></i> تاريخ الطلب
                    </label>
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4 bg-white">
        <div class="card-header bg-white border-0 py-3.5 px-4 d-flex align-items-center justify-content-between border-bottom border-light">
            <div class="d-flex align-items-center gap-2">
                <i class="fa-solid fa-list-check text-plum fs-5"></i>
                <h5 class="fw-bold mb-0 text-dark fs-6">قائمة الطلبات</h5>
            </div>
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover orders-table align-middle mb-0">
                    ...
                    <tbody>
                        @include('users.sellers.components.content.orders.partials.orders_table')
                    </tbody>
                </table>
            </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
                ...
                <div class="table-responsive rounded-3 border">
                    <table class="table table-bordered align-middle mb-0">
                        ...
                        <tfoot class="table-light fw-bold">
                            ...
                            <tr>
                                <td colspan="4" class="text-start text-plum">الإجمالي الكلي</td>
            ...
            <div class="modal-footer bg-light px-4 py-3 border-top-0">
                ...
                <button type="button" class="btn btn-seller-primary rounded-3 px-4 fw-bold shadow-sm d-flex align-items-center gap-2" onclick="printInvoice()">
                ...
                <div class="d-flex flex-column gap-3">
                    @foreach ($companies as $company)
                        <div class="p-3 border rounded-3 bg-light d-flex align-items-center justify-content-between shadow-sm hover-shadow transition-all">
                            ...
                            <button class="btn btn-seller-primary btn-sm px-3 rounded-2 fw-semibold create_company_parcel"
...
<!-- Modern CSS Styles -->
<style>
/* Modern Color Tokens for Seller Panel */
:root {
    --seller-plum: #a40c72;
