<script>
    ...
    async function fetchOrderDetails(orderId) {
        try {
            const response = await fetch(`/seller-panel/order/${orderId}`);
...
`;
  ...
  `;
                ...
                acceptBtn.addEventListener("click", async function(e) {
                    ...
                    try {
                        const response = await fetch(
                            `/seller-panel/order/${order.id}/accept-payment`, {
                                method: "POST",
                                headers: {
        ...
        `,
                    ...
                    try {
                        const response = await fetch(
                            `/seller-panel/order/${order.id}/reject-payment`, {
                                method: "POST",
                                headers: {
                                    "X-CSRF-TOKEN": "{{ csrf_token() }}",
                                    "Content-Type": "application/json"
    ...
    async function deleteOrderItem(orderId, itemId) {
        try {
            ...
            await fetch('/seller-panel/delete-order-item/' + itemId);
    ...
    async function print_wilaya_name(id) {
        try {
            const response = await fetch('/seller-panel/get-wilaya-data/' + id);
            if (!response.ok) throw new Error('Network response was not ok');
