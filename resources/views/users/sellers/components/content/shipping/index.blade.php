        ...
        <div class="row align-items-center position-relative z-1">
            <div class="col-lg-8 mb-3 mb-lg-0">
                <div
                    ...
                    <span class="fw-semibold">{{ __('إدارة شركات وتكاملات الشحن') }}</span>
                    <span class="opacity-50">|</span>
                    <span class="opacity-90">{{ now()->locale('ar')->translatedFormat('l، j F Y') }}</span>
                </div>
                <h1 class="display-6 fw-bold mb-2 text-white text-start">
                    إدارة شركات الشحن والتكامل الذكي 📦
                </h1>
                <p class="text-white-50 mb-0 leading-relaxed fs-6">
                    ربط شركات الشحن الجزائرية (Yalidine, ZRexpress, Maystro, DHD...)، تفعيل الخدمات، وإدارة التسعيرات المخصصة لمتجرك بكل سهولة.
                </p>
            </div>
            <div class="col-lg-4 text-lg-end">
                <div class="d-flex flex-wrap gap-2 justify-content-lg-end">
                    ...
                    <a class="btn btn-light text-dark fw-bold px-3.5 py-2.5 rounded-3 border-0 shadow-sm d-inline-flex align-items-center gap-2"
                        href="{{ route('seller.shipping.edit') }}">
                        <i class="fas fa-calculator me-1 text-plum"></i>
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4 bg-white">
        <div class="card-header bg-white border-0 py-3.5 px-3 px-md-4 d-flex flex-wrap align-items-center justify-content-between gap-2 border-bottom border-light">
            <div class="d-flex flex-wrap align-items-center gap-2">
                ...
                <h5 class="fw-bold mb-0 text-dark fs-6">شركات الشحن المدمجة بالحساب</h5>
            </div>
            <button class="btn btn-sm btn-seller-primary rounded-3 px-3 py-1.5 fw-bold d-inline-flex align-items-center gap-1.5" data-bs-toggle="modal" data-bs-target="#ShippingCompaniesModal">
                            ...
                            <div class="card integration-card h-100 shadow-sm rounded-4 position-relative border border-light-subtle bg-white hover-lift transition-all">
                                ...
                                <div class="card-body text-center p-4">
                                    ...
                                    <p class="card-text text-muted small mb-4 leading-relaxed">
                                        رفع طلبات العملاء إلى شركة الشحن <strong class="text-plum">{{ $company->name }}</strong> بضغطة زر واحدة تلقائياً.
                                    </p>
                                    ...
                                    <div class="d-flex justify-content-center align-items-center flex-wrap gap-2 pt-2 border-top border-light">
                                        ...
                                        {{-- زر الإعدادات --}}
                                        <button class="btn btn-sm btn-outline-plum rounded-3 px-3 py-1.5 fw-semibold" data-bs-toggle="modal"
                    ...
                    <div class="col-12">
                        <div class="card h-100 text-center p-5 shadow-sm border border-2 border-dashed rounded-4 bg-light-subtle">
                            <div class="card-body py-4">
                                ...
                                <p class="text-muted mb-4 max-w-md mx-auto fs-6">قم بإضافة وتفعيل إحدى شركات الشحن المتاحة لتمكين خيارات التوصيل والطلب التلقائي لعملائك.</p>

                                <div class="d-flex justify-content-center">
                                    <button class="btn btn-seller-primary rounded-3 px-4 py-2.5 fw-bold shadow-sm d-inline-flex align-items-center gap-2" data-bs-toggle="modal"
...
<div class="modal fade" id="ShippingCompaniesModal" tabindex="-1" aria-labelledby="ShippingCompaniesModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            <div class="modal-header bg-seller-header py-3.5 px-4">
            ...
            <div class="modal-body p-4">
                <p class="text-muted small mb-3">اختر شركة الشحن المراد ربط حسابك بها لإدخال بيانات الـ API والتفعيل:</p>
        ...
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            <form id="YALIDINEForm">
                ...
                <div class="modal-footer bg-light border-0 py-3 px-4">
                    ...
                    <button type="submit" class="btn btn-seller-primary rounded-3 px-4 fw-bold shadow-sm">
...
<div class="modal fade" id="EcotrackModal" tabindex="-1" aria-labelledby="EcotrackModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            ...
            <div class="modal-footer bg-light border-0 py-3 px-4">
                <button type="button" class="btn btn-light rounded-3 px-3 fw-semibold" data-bs-dismiss="modal">إغلاق</button>
                <button type="button" class="btn btn-seller-primary rounded-3 px-4 fw-bold shadow-sm">حفظ</button>
            </div>
        </div>
    </div>
</div>
...
<style>
    ...
    .bg-seller-header {
        background: linear-gradient(135deg, #5b073e 0%, #a40c72 50%, #be0681 100%) !important;
    ...
    .company-select-card:hover {
        border-color: #a40c72 !important;
        background-color: rgba(164, 12, 114, 0.02);
    }
