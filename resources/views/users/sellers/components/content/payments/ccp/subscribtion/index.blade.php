        ...
        <div class="row align-items-center position-relative z-1">
            <div class="col-lg-8 mb-3 mb-lg-0">
                <div
                    ...
                    <span class="fw-semibold">{{ __('الدفع عبر الحوالات البريدية CCP') }}</span>
                    <span class="opacity-50">|</span>
                    <span class="opacity-90">{{ now()->locale('ar')->translatedFormat('l، j F Y') }}</span>
                </div>
                <h1 class="display-6 fw-bold mb-2 text-white text-start">
                    بيانات الدفع عبر CCP 🏦
                </h1>
                <p class="text-white-50 mb-0 leading-relaxed fs-6">
                    قم بإرسال الحوالة البريدية إلى الحساب البريدي الجاري الموضح أدناه، ثم ارفع إيصال الدفع لتأكيد الطلب.
                </p>
            </div>
            ...
            @else
                <div class="card border-0 shadow-sm rounded-4 overflow-hidden bg-white h-100">
                    ...
                    <div class="card-body p-4 p-md-5">
                        <form action="{{ route('seller.subscription.payment.ccp') }}" method="POST" enctype="multipart/form-data">
                            @csrf
