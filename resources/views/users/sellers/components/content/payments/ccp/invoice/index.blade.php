<div class="container mt-4">
    ...
    <div class="text-center mb-4">
        <img src="{{ asset('asset/v1/users/dashboard/img/payments/algerie post.png') }}" alt="تطبيق بريدي موب" class="img-fluid" style="max-width: 200px;">
        <p class="text-muted mt-2">يرجى الدفع عبر بريد الجزائر ورفع إيصال الدفع أدناه</p>
    </div>
