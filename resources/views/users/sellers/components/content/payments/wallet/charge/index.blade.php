        ...
        <div class="row align-items-center position-relative z-1">
            <div class="col-lg-7 mb-3 mb-lg-0">
                <div
                    ...
                    <span class="fw-semibold">{{ __('إدارة المحفظة الإلكترونية والرصيد') }}</span>
                    <span class="opacity-50">|</span>
                    <span class="opacity-90">{{ now()->locale('ar')->translatedFormat('l، j F Y') }}</span>
                </div>
                <h1 class="display-6 fw-bold mb-2 text-white text-start">
                    إدارة وشحن المحفظة الإلكترونية 👛
                </h1>
                <p class="text-white-50 mb-0 leading-relaxed fs-6">
                    تابع أرصدتك الحالية والمتبقية، واشحن محفظتك بمرونة عبر وسائل الدفع الوطنية المتاحة لإكمال معاملتك فورًا.
                </p>
            </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white hover-lift transition-all">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <span class="badge bg-success-subtle text-success rounded-pill px-3 py-1 fw-bold">متاح لاستخدام</span>
                    </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white hover-lift transition-all">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <span class="badge bg-plum-subtle text-plum rounded-pill px-3 py-1 fw-bold">إجمالي العمليات</span>
                    </div>
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4 bg-white">
        <div class="card-header bg-white border-0 py-3.5 px-3 px-md-4 d-flex flex-wrap align-items-center justify-content-between gap-2 border-bottom border-light">
            <div class="d-flex flex-wrap align-items-center gap-2">
                ...
                <h5 class="fw-bold mb-0 text-dark fs-6">سجل عمليات شحن المحفظة</h5>
            </div>
            <button class="btn btn-seller-primary rounded-3 px-3.5 py-2 fs-6 fw-bold shadow-sm d-inline-flex align-items-center gap-2"
                data-bs-toggle="modal" data-bs-target="#selectPaymentMethodModal">
                <i class="fa-solid fa-plus-circle"></i>
                            ...
                            <tr>
                                ...
                                <td data-label="طريقة الدفع">
                                    <span class="badge bg-light text-dark border px-2.5 py-1.5 fw-semibold">
                                        <i class="fa-solid fa-credit-card me-1 text-plum"></i> {{ $addition->payment_method }}
                                    </span>
                                </td>
                                ...
                                <td data-label="الإثبات" class="text-center">
                                    @if($addition->payment_proof)
                                        <a href="{{ asset('storage/app/public/seller/' . $addition->payment_proof) }}" target="_blank"
                                            class="btn btn-sm btn-outline-plum rounded-3 px-2.5 py-1 small d-inline-flex align-items-center gap-1">
                                ...
                                <td data-label="الإجراء" class="text-center pe-md-4">
                                    <button class="btn btn-light btn-sm text-dark rounded-3 px-3 py-1.5 border d-inline-flex align-items-center gap-1"
                                        ...
                                        <i class="fa-solid fa-eye text-plum"></i>
                                        <span>التفاصيل</span>
                                    </button>
                                </td>
                            </tr>
            ...
            <div class="modal-body p-4 bg-white">
                <div id="invoice-details-content">
                    <div class="text-center py-4 text-muted">
                        <div class="spinner-border spinner-border-sm text-plum me-2" role="status"></div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            ...
            <div class="modal-body p-4 bg-white text-center">
                ...
                <!-- طريقة 1: Chargily -->
                <button class="btn btn-outline-plum w-100 py-3 mb-3 rounded-3 fw-bold d-flex align-items-center justify-content-between px-3"
                    data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#chargeBalanceModal">
                    <div class="d-flex align-items-center gap-2">
                        <i class="fa-solid fa-credit-card fs-5 text-plum"></i>
            ...
            <div class="modal-body p-4 bg-white">
                <form id="chargilyForm" method="POST" action="{{ route('seller.chargilypay.redirect') }}">
                    ...
                    <div class="mb-3.5 text-start">
                        ...
                        <small class="text-muted d-block mt-2 fs-7"><i class="fa-solid fa-circle-info text-plum me-1"></i> الحد الأدنى للشحن هو 50 د.ج</small>
                    </div>
