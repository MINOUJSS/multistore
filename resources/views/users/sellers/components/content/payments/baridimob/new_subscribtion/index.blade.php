        ...
        <div class="row align-items-center position-relative z-1">
            <div class="col-lg-8 mb-3 mb-lg-0">
                <div
                    ...
                    <span class="fw-semibold">{{ __('الدفع الإلكتروني عبر بريدي موب (اشتراك جديد)') }}</span>
                ...
                <p class="text-white-50 mb-0 leading-relaxed fs-6">
                    قم بتحويل قيمة تفعيل الخطة عبر تطبيق BaridiMob ورفع صورة الإثبات لإكمال طلب الاشتراك الجديد.
                </p>
            </div>
                ...
                <form action="{{ route('seller.new.subscription.payment.baridimob') }}" method="POST" enctype="multipart/form-data" class="text-start">
                    ...
                    <div class="mb-4">
                        <label for="payment_proof" class="form-label fw-bold text-dark small">
                            <i class="fa-solid fa-cloud-arrow-up text-plum me-1"></i> رفع إيصال الدفع <span class="text-danger">*</span>
                        </label>
