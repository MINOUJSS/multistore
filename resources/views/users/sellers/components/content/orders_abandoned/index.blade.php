        ...
        <div class="col-6 col-md-4 col-xl-2">
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white hover-lift transition-all">
                <div class="card-body p-3.5">
                    ...
                    <p class="text-muted small mb-0 fw-semibold">كل السلات المتروكة</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-6 col-md-4 col-xl-2">
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white hover-lift transition-all">
                <div class="card-body p-3.5">
                    ...
                    <p class="text-muted small mb-0 fw-semibold">قيد التذكير/المتابعة</p>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white hover-lift transition-all">
                <div class="card-body p-3.5">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <span class="badge bg-success-subtle text-success rounded-pill small">مسترجعة</span>
                    </div>
                    <h3 class="fw-bold mb-1 text-dark fs-4">{{ $orderStats['delivered'] ?? 0 }}</h3>
                    <p class="text-muted small mb-0 fw-semibold">سلات تم استرجاعها</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            <div class="modal-header bg-white border-bottom border-light py-3 px-4">
                <div class="d-flex align-items-center gap-2">
                    <i class="fa-solid fa-receipt text-plum fs-5"></i>
                    <h5 class="modal-title fw-bold text-dark fs-6">تفاصيل السلة المتروكة <span id="order-number" class="text-plum ms-1"></span></h5>
                </div>
            ...
            <div class="modal-body p-4">
                ...
                <h6 class="fw-bold text-dark mb-3">
                    <i class="fa-solid fa-box-open text-plum me-1"></i> محتويات السلة
                </h6>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tfoot class="bg-light-subtle fw-bold">
                            ...
                            <tr class="table-active">
                                ...
                                <td class="text-end text-plum fs-6"><strong id="total-price"></strong></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
            ...
            <div class="modal-footer bg-light border-top border-light py-3 px-4">
                ...
                <button type="button" class="btn btn-seller-primary rounded-3 fw-bold px-4 d-flex align-items-center gap-2" onclick="printInvoice()">
...
<style>
.bg-plum-subtle { background-color: rgba(164, 12, 114, 0.1); }
