...
<div class="app-sidebar">
    <div class="logo-box text-center">
        <div class="logo-avatar-wrapper mb-2">
            <img class="logo-image" src="{{ get_store_logo(Auth::user()->tenant_id) }}" alt="Store Logo" width="56"
                height="56">
...
<div class="offcanvas offcanvas-start d-lg-block d-lg-none d-xl-block d-xl-none d-xxl-block d-xxl-none"
    ...
    <div class="offcanvas-body pt-0">
        <div class="logo-box text-center">
            <div class="logo-avatar-wrapper mb-2">
                <img class="logo-image" src="{{ get_store_logo(Auth::user()->tenant_id) }}" alt="Store Logo"
                    width="56" height="56">
                @if (get_seller_data(Auth::user()->tenant_id)->approval_status == 'approved')
                    <span class="verified-badge" title="متجر موثق">
                        <i class="bi bi-check-lg"></i>
