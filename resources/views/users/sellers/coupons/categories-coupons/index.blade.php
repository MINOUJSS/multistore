...
@section('content')
{{-- Your Content Here   --}}
  @include('users.sellers.components.content.coupons.categories-coupons.index')
@endsection

@section('footer_js')
    {{-- @include('users.sellers.components.content.coupons.js.coupon_js') --}}
@endsection