        ...
        <div class="dz-auth-box">
          ...
          <form action="{{ route('seller.login') }}" method="POST">
            ...
            <div class="mb-3 form-check">
              ...
              <a class="forget-link" href="{{route('seller.password.request')}}">نسيت كلمة المرور؟</a>
            </div>
            <button type="submit" class="btn dz-btn-primary">متابعة</button>
            <div class="mb-3 form-check">
              <label class="form-check-label" for="exampleCheck1">ليس لديك حساب على منصتنا؟<a href="{{route('seller.register')}}"> تسجيل حساب جديد</a></label>
            </div>
          </form>
        </div>
      </div>
