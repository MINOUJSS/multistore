...
@section('title')
    500 - خطأ في الخادم | لوحة تحكم البائع
@endsection
    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-6 text-center">
            <div class="card border-0 shadow-sm rounded-4 bg-white p-4 p-md-5 position-relative overflow-hidden">
                ...
                <h2 class="fw-bold text-dark mb-3 fs-3">عذراً، حدث خطأ غير متوقع!</h2>
                
                <p class="text-muted mb-4 fs-6 leading-relaxed">
                    نواجه صعوبة فنية مؤقتة في معالجة طلبك داخل لوحة التحكم. يعمل فريق الدعم على معالجة المشكلة فوراً.
                </p>
