...
@section('content')
{{-- Your Content Here   --}}
  @include('users.sellers.components.content.pages.sections.categories.index')
@endsection

@section('footer_js')
    @include('users.sellers.components.content.pages.sections.categories.js.index_js')
@endsection