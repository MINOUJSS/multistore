...
@section('content')
{{-- Your Content Here   --}}
  @include('users.sellers.components.content.orders.index')
@endsection
@section('footer_js')
  ...
  @include('users.sellers.components.content.orders.js.create_parcel_js')
  @include('users.sellers.components.content.orders.js.tracking_parcel_js')
  @include('users.sellers.components.content.orders.js.delete_parcel_js')
  @include('users.sellers.components.content.orders.js.change_confirmation_status_js')
@endsection