<!-- Start Sid Bar  -->
<style>
    /* Modernized Admin Sidebar CSS */
    .app-sidebar,
    .offcanvas-body {
        background: #a40c72 !important;
        /* Preserved primary base color */
...
<div class="app-sidebar">
    <div class="logo-box text-center">
        <div class="logo-avatar-wrapper mb-2">
            <img class="logo-image" src="{{ asset('asset/v1/users/dashboard') }}/img/logo/store.png" alt="Admin Logo" width="56" height="56">
            <span class="verified-badge" title="مدير النظام">
                <i class="bi bi-shield-check"></i>
            </span>
        </div>
        <div class="user-name">
            <span class="user-tenant-badge">
                <i class="fa-solid fa-user-shield me-1 small"></i> {{ Auth::guard('admin')->user()->name ?? Auth::guard('admin')->user()->type ?? 'أدمن' }}
            </span>
        </div>
    </div>   
    <hr class="my-3 opacity-25 text-white">
    <!--Start Menu-->
    @include('admins.admin.components.sidbar.inc.menu.index')
    <!--End Menu-->
</div>
<!-- End Sid Bar  -->
