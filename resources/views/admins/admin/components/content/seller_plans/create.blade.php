        ...
        <div class="row align-items-center position-relative z-1">
            <div class="col-lg-8 mb-3 mb-lg-0">
                <div class="d-inline-flex align-items-center gap-2 px-3 py-1 bg-white bg-opacity-10 rounded-pill text-white small mb-3 border border-white border-opacity-10">
                    ...
                    <span>خطط تجار التجزئة</span>
                </div>
                <h1 class="display-6 fw-bold mb-2 text-white text-start">
                    ✨ إنشاء خطة تاجر تجزئة جديدة
                </h1>
                <p class="text-white-50 mb-0 leading-relaxed text-start">
                    قم بملء البيانات الأساسية لخطة البائع، وبعد الحفظ ستتمكن من تخصيص فترات التسعير المتعددة (30، 90، 180، 365 يوماً) وإدارة الصلاحيات والمميزات.
                </p>
            </div>
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('admin.seller_plans.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text"
                                   ...
                                   placeholder="مثال: الخطة المجانية، الخطة المتوسطة، الخطة المتقدمة..."
                                   value="{{ old('name') }}"
                                   required>
                            @error('name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="text-muted">الاسم الذي يظهر للبائعين وتجار التجزئة عند التسجيل أو ترقية الاشتراك.</small>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            @enderror
                            <small class="text-muted">أدخل 0 إذا كانت الخطة مجانية. يمكنك إضافة فترات تسعير إضافية بمدد مختلفة لاحقاً.</small>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description"
                                      ...
                                      placeholder="اكتب وصفاً موجزاً يوضح لمن تناسب هذه الخطة وأهم ميزاتها...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="alert alert-info rounded-3 border-0 d-flex align-items-center gap-2 p-3 mb-4" style="background-color: rgba(79, 70, 229, 0.08); color: #3730a3;">
                            ...
                            <div class="small">
                                <strong>ملاحظة هامة:</strong> بعد الحفظ، ستنتقل إلى صفحة تفاصيل الخطة لتحديد مدد الاشتراك (شهري، ربع سنوي، سنوي) وضبط الصلاحيات (البيكسل، الدومين، بوابات الدفع).
                            </div>
                        </div>

                        <div class="d-flex align-items-center justify-content-end gap-2 pt-2 border-top">
                            <a href="{{ route('admin.seller_plans.index') }}" class="btn btn-light px-4 py-2 rounded-3 text-muted fw-semibold">
                                إلغاء
                            </a>
