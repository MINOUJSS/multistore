        ...
        <div class="row align-items-center position-relative z-1">
            ...
            <div class="col-lg-4 text-lg-end">
                <div class="d-flex flex-wrap gap-2 justify-content-lg-end">
                    <a href="{{ route('admin.seller_plans.show', $plan->id) }}" class="btn btn-warning text-dark fw-bold px-3 py-2 rounded-3 border-0 shadow-sm">
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('admin.seller_plans.update', $plan->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="d-flex align-items-center justify-content-end gap-2 pt-2 border-top">
                            <a href="{{ route('admin.seller_plans.show', $plan->id) }}" class="btn btn-light px-4 py-2 rounded-3 text-muted fw-semibold">
                                إلغاء
                            </a>
