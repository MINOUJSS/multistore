    ...
    <div class="card shadow-sm border-0 rounded-4 w-100 overflow-hidden" style="max-width: 100%;">
        <div class="card-body p-0">
            <div class="table-responsive p-0">
                <table class="table table-bordered table-hover text-center align-middle mb-0" id="supplierSubscribesPaymentsTable">
                    ...
                    <tbody>
                        @foreach($subscriptionRequests as $index => $order)
                            <tr>
                                ...
                                <td data-label="المورد" class="fw-semibold">{{ $order->supplier->full_name ?? '—' }}</td>
