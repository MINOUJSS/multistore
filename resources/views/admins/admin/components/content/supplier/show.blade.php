                ...
                <div class="card border-0 shadow-sm rounded-4 bg-white h-100 p-4">
                    ...
                    @else
                        <div class="p-4 bg-light rounded-3 text-center text-muted my-auto">
                            ...
                            <p class="small text-muted mb-0">لم يقم هذا المورد بإدخال بيانات حسابه البنكي أو البريدي (CCP/RIP) في إعدادات متجره بعد.</p>
                        </div>
                    @endif
                </div>
            </div>
                ...
                <div class="card border-0 shadow-sm rounded-4 bg-white h-100 p-4">
                    ...
                    @else
                        <div class="p-4 bg-light rounded-3 text-center text-muted my-auto">
                            ...
                            <p class="small text-muted mb-0">لم يقم هذا المورد بربط مفاتيح API الخاصة ببوابة Chargily Pay (CIB / الذهبية) في متجره بعد.</p>
                        </div>
                    @endif
                </div>
            </div>
            ...
            <div class="card-header bg-white border-0 p-4 d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between gap-3 border-bottom">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <small class="text-muted">مراجعة التحويلات ووصولات الدفع المرفوعة لطلبات الزبائن الخاصة بمتجر هذا المورد</small>
                    </div>
                </div>
            ...
            <div class="card-body p-0">
                ...
                @else
                    <div class="p-5 text-center text-muted">
                        ...
                        <p class="small text-muted mb-0">عندما يقوم زبائن هذا المورد برفع وصولات الدفع للطلبات عبر التحويل البنكي، ستظهر هنا للمراقبة والتدقيق الإداري.</p>
                    </div>
                @endif
            </div>
        </div>
