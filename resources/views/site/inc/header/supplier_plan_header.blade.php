        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1"
                ...
                <h1 class="hero-main-title fw-bold text-white mb-3">
                    {{ __('site.header_supplier_plan_title') }}
                </h1>

                <!-- Subtitle / Description -->
                <h2 class="hero-sub-title mb-4 fs-5">
                    {{ __('site.header_supplier_plan_description') }}
                </h2>
                ...
                <div
                    ...
                    <a href="{{ 'http://supplier.' . request()->getHost() . route('supplier.login', [], false) }}"
                    ...
                    <a href="https://youtu.be/REQ9iOLgLxg"
                        ...
                        <span class="fw-semibold text-white">{{ __('site.how_to_register_on_the_platform_as_a_supplier') }}</span>
                    </a>
                </div>
            ...
            <div class="col-lg-6 order-1 order-lg-2 hero-img text-center position-relative" data-aos="zoom-in"
                ...
                <div class="hero-img-wrapper position-relative d-inline-block">
                    <img src="{{ asset('asset/v1/site/defaulte') }}/img/hero.jpeg"
                        class="img-fluid animated rounded-4 shadow-lg border border-white-20" alt="Supplier Plan Hero">
...
</section><!-- End Supplier Plan Hero -->