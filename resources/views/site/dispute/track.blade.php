...
<section id="hero" class="d-flex align-items-center position-relative overflow-hidden py-5" style="min-height: 38vh;">
    ...
    <div class="container position-relative z-index-2 py-4 text-center">
        ...
        <div class="d-inline-flex align-items-center gap-2 mb-3 hero-badge-pill">
            ...
            <span class="badge-text fw-bold">{{ __('site.dispute_track_badge') }}</span>
        </div>

        <!-- Main Title -->
        <h1 class="hero-main-title fw-bold text-white mb-3 fs-2 fs-md-1">
            {{ __('site.dispute_track_title') }} #{{ $dispute->order_number }}
        </h1>

        <!-- Subtitle -->
        <p class="hero-sub-title mb-4 fs-6 mx-auto text-white-80" style="max-width: 740px;">
            {{ __('site.dispute_track_subtitle') }}
        </p>
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-center gap-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent p-0 m-0 text-white-50">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('site.dispute.create') }}" class="text-white text-decoration-none fw-semibold">{{ __('site.dispute_create_breadcrumb') }}</a></li>
                    <li class="breadcrumb-item active text-pink-accent fw-bold" aria-current="page">{{ __('site.dispute_track_breadcrumb') }}</li>
                </ol>
            </nav>
        </div>
    </div>
...
@section('content')
@include('site.pages.dispute.track')
@endsection

@section('pricing')
{{-- Full backward compatibility with layout --}}
@endsection

@section('footer_js')
@include('site.pages.dispute.js.track_js')
@endsection