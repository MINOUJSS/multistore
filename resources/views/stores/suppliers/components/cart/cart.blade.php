      ...
      <div class="offcanvas offcanvas-end" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1"
          ...
          <div class="offcanvas-body">
                  ...
                  <div class="cart-list" bis_skin_checked="1">
                      <form action="/">
                          <ul class="list-unstyled">
                              <li class="cart-item">
                                  <img src="{{ asset('asset/v1/users/store') }}/img/logo/store.png" alt="إسم المنتج"
                                      class="item-thumbnail" width="50px" height="50px">
                                      ...
                                      <div class="item-details" bis_skin_checked="1">
                                          ...
                                          <div class="quantity-wrapper" bis_skin_checked="1">
                                              ...
                                              <span class="currency-value"><span class="value">199</span>
                                                  <span class="currency">&nbsp;د.ج</span></span>
                                          </div>
                                      </div>
              ...
              <footer class="cart-footer bg-body-tertiary">
                  <h6>مجموع سلة التسوق
                      <span class="currency-value"><span class="value">0</span><span
                              class="currency">&nbsp;د.ج</span></span>
                  </h6>
