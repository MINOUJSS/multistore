...
const subTotal = extractNumber(subTotalElement.textContent);
const shippingPrice = extractNumber(shippingPriceElement.textContent);
const discount = extractNumber(discountElement.textContent);
...
function selectOption(option) {
    ...
    //
    @if(session('cart')->free_shipping=='no')
