...
@section('title')
    {{ tenant('domain') }} | 404 - منتج التوريد غير متوفر
@endsection
                ...
                <div class="card p-4 p-md-5 store-error-box">
                    <div class="mb-4">
                        <div class="store-error-icon-wrapper shadow-xs">
                            <i class="fa-solid fa-boxes-packing fs-1 text-secondary"></i>
                        </div>
                    </div>

                    <div class="d-inline-block mx-auto mb-3">
                        <span class="badge bg-secondary text-white px-3 py-1.5 rounded-pill fw-bold" style="font-size: 0.85rem;">
                            خطأ 404
                        </span>
                    </div>

                    <h2 class="fw-bold mb-3 title fs-3">عذراً، منتج الجملة أو الصفحة غير متوفرة!</h2>
                    <p class="text-muted mb-4 fs-6 leading-relaxed">
                        منتج التوريد أو الرابط الذي تبحث عنه في المتجر غير متاح حالياً أو قد تم نقله. يمكنك تصفح كتالوج الجملة للمزيد.
                    </p>

                    <div class="d-flex flex-wrap gap-2 justify-content-center align-items-center">
                        <a href="{{ route('tenant.products') }}" class="btn btn-primary fw-bold px-4 py-2.5 rounded-pill shadow-sm">
                            <i class="fa-solid fa-boxes-stacked me-1"></i> كتالوج التوريد
                        </a>
