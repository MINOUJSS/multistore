                                                ...
                                                <small class="text-muted">
                                                    @if (!empty($attribute['attribute']))
                                                        اللون: <span class="color-swatch"
                                                            style="background-color:{{ get_seller_product_variation_data($item['variation_ids'][$variation_ids[$i]]['variation']['id'])->color }}">C</span>
                                                    @endif

                                                    @if (!empty($attribute['attribute']))
                                                        | المقاس:
                                                        {{ get_seller_product_variation_data($item['variation_ids'][$variation_ids[$i]]['variation']['id'])->size }}
                                                    @endif
                                                    @if (!empty($attribute['attribute']))
                                                        | الوزن:
                                                        {{ get_seller_product_variation_data($item['variation_ids'][$variation_ids[$i]]['variation']['id'])->weight }}
                                                    @endif
                                                </small>
                                            </div>
                                        </div>
