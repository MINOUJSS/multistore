                    ...
                    <td>
                        <div class="input-group input-group-sm quantity-control" style="width: 120px;"
                            ...
                            <input type="number" class="form-control quantity-input"
                                value="{{ $item['variation_ids'][0]['qty'] }}" min="{{ seller_product_min_qty($item['id']) }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group input-group-sm quantity-control" style="width: 120px;"
                                    ...
                                    <input type="number" class="form-control quantity-input"
                                        value="{{ $variation['qty'] }}" min="{{seller_product_min_qty($item['id'])}}">
                                    <button class="btn btn-outline-secondary increment-btn" type="button">
                                        <i class="fas fa-plus"></i>
                                    </button>
                                </div>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex">
                                    ...
                                    <div>
                                        ...
                                        <small class="text-muted">
                                            {{-- attribute only --}}
                                            {{get_seller_attribute_data($attribute['attribute']['attribute_id'])->name}} :
                            ...
                            <td>
                                <div class="input-group input-group-sm quantity-control" style="width: 120px;"
                                    ...
                                    {{-- {{dd($item['variation_ids'][$variation_ids[$i]])}} --}}
                                    <input type="number" class="form-control quantity-input"
                                        value="{{ $attribute['qty'] }}" min="{{seller_product_min_qty($item['id'])}}">
                                    <button class="btn btn-outline-secondary increment-btn" type="button">
                                        <i class="fas fa-plus"></i>
                                    </button>
                                </div>
                            ...
                            <td>
                                <div class="input-group input-group-sm quantity-control" style="width: 120px;"
                                    ...
                                    <input type="number" class="form-control quantity-input"
                                        ...
                                        min="{{seller_product_min_qty($item['id'])}}">
                                    <button class="btn btn-outline-secondary increment-btn" type="button">
                                        <i class="fas fa-plus"></i>
                                    </button>
                                </div>
