        ...
        <div class="row justify-content-center text-center">
            <div class="col-12 col-md-9 col-lg-7">
                <div class="card p-4 p-md-5 store-error-box">
                    ...
                    <h2 class="fw-bold mb-3 title fs-3">انتهت صلاحية جلسة الطلب!</h2>
                    <p class="text-muted mb-4 fs-6 leading-relaxed">
                        انتهت صلاحية الجلسة أو نموذج إرسال الطلب بسبب عدم النشاط لفترة. يرجى تحديث الصفحة لمتابعة التسوق.
                    </p>
